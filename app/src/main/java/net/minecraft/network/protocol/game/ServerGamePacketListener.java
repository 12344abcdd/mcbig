...
public interface ServerGamePacketListener extends ServerPingPacketListener, ServerCommonPacketListener {
    ...
    void handleAcceptPlayerLoad(ServerboundPlayerLoadedPacket p_386931_);

    void handleRecipeBookSeenRecipePacket(ServerboundRecipeBookSeenRecipePacket p_133768_);

    void handleBundleItemSelectedPacket(ServerboundSelectBundleItemPacket p_364061_);
    ...
    void handlePickItemFromBlock(ServerboundPickItemFromBlockPacket p_383031_);

    void handlePickItemFromEntity(ServerboundPickItemFromEntityPacket p_382904_);
    ...
    void handleClientTickEnd(ServerboundClientTickEndPacket p_365161_);
}
