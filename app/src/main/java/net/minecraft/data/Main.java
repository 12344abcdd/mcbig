...
public class Main {
    ...
    public static void addServerProviders(DataGenerator p_388215_, Collection<Path> p_386664_, boolean p_388567_, boolean p_388811_, boolean p_386742_) {
        DataGenerator.PackGenerator datagenerator$packgenerator = p_388215_.getVanillaPack(p_388567_);
        datagenerator$packgenerator.addProvider(p_253388_ -> new SnbtToNbt(p_253388_, p_386664_).addFilter(new StructureUpdater()));
        ...
        DataGenerator.PackGenerator datagenerator$packgenerator1 = p_388215_.getVanillaPack(p_388567_);
        ...
        datagenerator$packgenerator1 = p_388215_.getVanillaPack(p_388811_);
        datagenerator$packgenerator1.addProvider(p_253386_ -> new NbtToSnbt(p_253386_, p_386664_));
        datagenerator$packgenerator1 = p_388215_.getVanillaPack(p_386742_);
        ...
        DataGenerator.PackGenerator datagenerator$packgenerator2 = p_388215_.getBuiltinDatapack(p_388567_, "trade_rebalance");
        ...
        datagenerator$packgenerator1 = p_388215_.getBuiltinDatapack(p_388567_, "redstone_experiments");
        ...
        datagenerator$packgenerator1 = p_388215_.getBuiltinDatapack(p_388567_, "minecart_improvements");
        datagenerator$packgenerator1.addProvider(
