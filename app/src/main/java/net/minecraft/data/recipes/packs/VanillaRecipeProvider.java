...
public class VanillaRecipeProvider extends RecipeProvider {
    ...
    VanillaRecipeProvider(HolderLookup.Provider p_364298_, RecipeOutput p_361287_) {
    ...
    protected void buildRecipes() {
        ...
        smithingTrims().forEach(p_378952_ -> this.trimSmithing(p_378952_.template(), p_378952_.id()));
    ...
    public static Stream<VanillaRecipeProvider.TrimTemplate> smithingTrims() {
        return Stream.of(
            ...
            .map(
                p_378953_ -> new VanillaRecipeProvider.TrimTemplate(
                        p_378953_, ResourceKey.create(Registries.RECIPE, ResourceLocation.withDefaultNamespace(getItemName(p_378953_) + "_smithing_trim"))
                    )
            );
    }
