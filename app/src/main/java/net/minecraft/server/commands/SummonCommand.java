...
public class SummonCommand {
    ...
    public static Entity createEntity(
        CommandSourceStack p_270582_, Holder.Reference<EntityType<?>> p_270277_, me.alphamode.mcbig.core.BigVec3 p_270366_, CompoundTag p_270197_, boolean p_270947_
        ...
        if (!Level.isInSpawnableBounds(blockpos)) {
            ...
            if (entity == null) {
                ...
                if (p_270947_ && entity instanceof Mob) {
                    ((Mob)entity)
                        .finalizeSpawn(
                            p_270582_.getLevel(), p_270582_.getLevel().getCurrentDifficultyAt(entity.blockPosition()), EntitySpawnReason.COMMAND, null
                        );
                }
    ...
    private static int spawnEntity(
        CommandSourceStack p_249752_, Holder.Reference<EntityType<?>> p_251948_, me.alphamode.mcbig.core.BigVec3 p_251429_, CompoundTag p_250568_, boolean p_250229_
    ) throws CommandSyntaxException {
