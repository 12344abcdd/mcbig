                        ...
                        .then(
                            Commands.argument("amount", FloatArgumentType.floatArg(0.0F))
                                .executes(
                                    p_382672_ -> damage(
                                            p_382672_.getSource(),
                                            EntityArgument.getEntity(p_382672_, "target"),
                                            FloatArgumentType.getFloat(p_382672_, "amount"),
                                            p_382672_.getSource().getLevel().damageSources().generic()
                                        )
                                )
                                .then(
                                                        ...
                                                        .executes(
                                                            p_270444_ -> damage(
                                                                    ...
                                                                    new DamageSource(
                                                                        ...
                                                                        Vec3Argument.getVec3(p_270444_, "location").toVanilla()
                                                                    )
                                                                )
                                                        )
                                                )
