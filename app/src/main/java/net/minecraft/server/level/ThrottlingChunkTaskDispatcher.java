...
public class ThrottlingChunkTaskDispatcher extends ChunkTaskDispatcher {
    private final it.unimi.dsi.fastutil.objects.ObjectSet<ChunkPos> chunkPositionsInExecution = new it.unimi.dsi.fastutil.objects.ObjectOpenHashSet<>();
    ...
    @Override
    protected void onRelease(ChunkPos p_371820_) {
