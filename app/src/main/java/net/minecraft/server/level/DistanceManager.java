...
//        long i = chunkpos.toLong();
    ...
    public it.unimi.dsi.fastutil.objects.ObjectIterator<ChunkPos> getSpawnCandidateChunks() {
        this.naturalSpawnChunkCounter.runAllUpdates();
    ...
    public it.unimi.dsi.fastutil.objects.ObjectSet<ChunkPos> getTickingChunks() {
            ...
            if (p_140921_ != p_140922_) {
                ...
                if (p_140922_) {
                    ...
                    DistanceManager.this.ticketDispatcher
                        .release(
                            p_140919_, () -> DistanceManager.this.mainThreadExecutor.execute(() -> DistanceManager.this.removeTicket(p_140919_, ticket)), true
                        );
                }
            }
        }
        ...
        public void runAllUpdates() {
            ...
            if (!this.toUpdate.isEmpty()) {
                ...
                while (longiterator.hasNext()) {
                    ...
                    if (j != k) {
                        DistanceManager.this.ticketDispatcher.onLevelChange(i, () -> this.queueLevels.getInt(i), k, p_140928_ -> {
