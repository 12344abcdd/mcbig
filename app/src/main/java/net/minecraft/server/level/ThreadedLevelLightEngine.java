...
public class ThreadedLevelLightEngine extends LevelLightEngine implements AutoCloseable {
    ...
    public ThreadedLevelLightEngine(LightChunkGetter p_9305_, ChunkMap p_9306_, boolean p_9307_, ConsecutiveExecutor p_371315_, ChunkTaskDispatcher p_371908_) {
        super(p_9305_, true, p_9307_);
        this.chunkMap = p_9306_;
        this.taskDispatcher = p_371908_;
        this.consecutiveExecutor = p_371315_;
    }
