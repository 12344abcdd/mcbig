...
public class ChunkTaskDispatcher implements ChunkHolder.LevelChangeListener, AutoCloseable {
    ...
    public void release(ChunkPos p_371596_, Runnable p_371195_, boolean p_371837_) {
    ...
    public void submit(Runnable p_371654_, ChunkPos p_371885_, IntSupplier p_371509_) {
    ...
    protected void onRelease(ChunkPos p_371807_) {
    }
