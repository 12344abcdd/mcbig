        ...
        try {
            ...
            try {
                ...
                worldstem = Util.<WorldStem>blockUntilDone(
                        p_372648_ -> WorldLoader.load(
                                worldloader$initconfig,
                                p_359487_ -> {
                                    Registry<LevelStem> registry = p_359487_.datapackDimensions().lookupOrThrow(Registries.LEVEL_STEM);
                                    if (dynamic1 != null) {
                                        LevelDataAndDimensions leveldataanddimensions = LevelStorageSource.getLevelDataAndDimensions(
                                            dynamic1, p_359487_.dataConfiguration(), registry, p_359487_.datapackWorldgen()
                                        );
                                        ...
                                        if (optionset.has(optionspec2)) {
                                            ...
                                            worlddimensions = WorldPresets.createNormalWorldDimensions(p_359487_.datapackWorldgen());
                                        } else {
                                            ...
                                            levelsettings = new LevelSettings(
                                                ...
                                                false,
                                                new GameRules(p_359487_.dataConfiguration().enabledFeatures()),
                                                p_359487_.dataConfiguration()
                                            );
