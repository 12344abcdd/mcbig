...
public class Mth {
    ...
    public static me.alphamode.mcbig.math.BigInteger bigFloor(me.alphamode.mcbig.math.BigDecimal p_14108_) {
        me.alphamode.mcbig.math.BigInteger i = p_14108_.toBigInteger();
    ...
    public static me.alphamode.mcbig.math.BigInteger bigCeil(me.alphamode.mcbig.math.BigDecimal p_14166_) {
        me.alphamode.mcbig.math.BigInteger i = p_14166_.toBigInteger();
        return p_14166_.compareTo(i.toBigDecimal()) > 0 ? i.add() : i;
    }
    ...
    public static me.alphamode.mcbig.math.BigDecimal clamp(me.alphamode.mcbig.math.BigDecimal p_14009_, me.alphamode.mcbig.math.BigDecimal p_14010_, me.alphamode.mcbig.math.BigDecimal p_14011_) {
    ...
    public static byte packDegrees(float p_368679_) {
        return (byte)floor(p_368679_ * 256.0F / 360.0F);
    }

    public static float unpackDegrees(byte p_368496_) {
        return (float)(p_368496_ * 360) / 256.0F;
    }
    ...
    public static float wrapDegrees(long p_361467_) {
        float f = (float)(p_361467_ % 360L);
        if (f >= 180.0F) {
            f -= 360.0F;
        }
    ...
    public static double frac(me.alphamode.mcbig.math.BigDecimal p_14186_) {
        return p_14186_.subtract(bigFloor(p_14186_).toBigDecimal()).doubleValue();
    }
    ...
    public static int hsvToArgb(float p_348601_, float p_348572_, float p_348491_, int p_348531_) {
        int i = (int)(p_348601_ * 6.0F) % 6;
        float f = p_348601_ * 6.0F - (float)i;
        float f1 = p_348491_ * (1.0F - p_348572_);
        float f2 = p_348491_ * (1.0F - f * p_348572_);
        float f3 = p_348491_ * (1.0F - (1.0F - f) * p_348572_);
        float f4;
        float f5;
        float f6;
        switch (i) {
            ...
            case 5:
                ...
                break;
            default:
                throw new RuntimeException("Something went wrong when converting from HSV to RGB. Input was " + p_348601_ + ", " + p_348572_ + ", " + p_348491_);
        }

        return ARGB.color(p_348531_, clamp((int)(f4 * 255.0F), 0, 255), clamp((int)(f5 * 255.0F), 0, 255), clamp((int)(f6 * 255.0F), 0, 255));
    }
    ...
    public static Vec3 lerp(double p_360479_, Vec3 p_363192_, Vec3 p_360708_) {
        return new Vec3(lerp(p_360479_, p_363192_.x, p_360708_.x), lerp(p_360479_, p_363192_.y, p_360708_.y), lerp(p_360479_, p_363192_.z, p_360708_.z));
    }
    ...
    public static float rotLerpRad(float p_360416_, float p_360960_, float p_364814_) {
        float f = p_364814_ - p_360960_;
    ...
    public static float length(float p_360288_, float p_364574_) {
        return (float)Math.sqrt(lengthSquared((double)p_360288_, (double)p_364574_));
    }
    ...
    public static float lengthSquared(float p_350890_, float p_350831_, float p_350696_) {
        return p_350890_ * p_350890_ + p_350831_ * p_350831_ + p_350696_ * p_350696_;
    }
    ...
    public static float easeInOutSine(float p_363522_) {
        return -(cos((float) Math.PI * p_363522_) - 1.0F) / 2.0F;
    }
