...
public class JfrResultJsonSerializer {
    ...
    private JsonElement structureGen(List<StructureGenStat> p_383149_) {
        JsonObject jsonobject = new JsonObject();
        TimedStatSummary<StructureGenStat> timedstatsummary = TimedStatSummary.summary(p_383149_);
        ...
        p_383149_.stream()
            ...
            .forEach(
                (p_382700_, p_382701_) -> {
                    ...
                    jsonobject1.addProperty("name", p_382700_);
                    TimedStatSummary<StructureGenStat> timedstatsummary1 = TimedStatSummary.summary((List<StructureGenStat>)p_382701_);
                    ...
                    timedstatsummary1.percentilesNanos().forEach((p_382695_, p_382696_) -> jsonobject2.addProperty("p" + p_382695_, p_382696_));
