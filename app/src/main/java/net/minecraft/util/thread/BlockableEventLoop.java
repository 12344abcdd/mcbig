...
public abstract class BlockableEventLoop<R extends Runnable> implements ProfilerMeasured, TaskScheduler<R>, Executor {
    ...
    public static boolean isNonRecoverable(Throwable p_361022_) {
        return p_361022_ instanceof ReportedException reportedexception
            ? isNonRecoverable(reportedexception.getCause())
            : p_361022_ instanceof OutOfMemoryError || p_361022_ instanceof StackOverflowError;
    }
}
