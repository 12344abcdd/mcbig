...
public enum Direction implements StringRepresentable {
    ...
    public static float getYRot(Direction p_363445_) {
        return switch (p_363445_) {
            case NORTH -> 180.0F;
            case SOUTH -> 0.0F;
            case WEST -> 90.0F;
            case EAST -> -90.0F;
            default -> throw new IllegalStateException("No y-Rot for vertical axis: " + p_363445_);
        };
    }
    ...
    public static Direction getApproximateNearest(double p_362121_, double p_364871_, double p_364153_) {
        return getApproximateNearest((float)p_362121_, (float)p_364871_, (float)p_364153_);
    }
    ...
    public static Direction getApproximateNearest(Vec3 p_361200_) {
        return getApproximateNearest(p_361200_.x, p_361200_.y, p_361200_.z);
    }

    @Nullable
    @Contract("_,_,_,!null->!null;_,_,_,_->_")
    public static Direction getNearest(int p_365087_, int p_364094_, int p_361757_, @Nullable Direction p_364698_) {
        int i = Math.abs(p_365087_);
        int j = Math.abs(p_364094_);
        int k = Math.abs(p_361757_);
        if (i > k && i > j) {
            return p_365087_ < 0 ? WEST : EAST;
        } else if (k > i && k > j) {
            return p_361757_ < 0 ? NORTH : SOUTH;
        } else if (j > i && j > k) {
            return p_364094_ < 0 ? DOWN : UP;
        } else {
            return p_364698_;
        }
    }
    ...
    public static Direction getNearest(Vec3i p_362245_, @Nullable Direction p_363910_) {
        return getNearest(p_362245_.getX(), p_362245_.getY(), p_362245_.getZ(), p_363910_);
    }
    ...
    public static enum Axis implements StringRepresentable, Predicate<Direction> {
        X("x") {
            ...
            @Override
            public me.alphamode.mcbig.math.BigInteger choose(me.alphamode.mcbig.math.BigInteger p_122496_, me.alphamode.mcbig.math.BigInteger p_122497_, me.alphamode.mcbig.math.BigInteger p_122498_) {
                return p_122496_;
            }
            ...
            @Override
            public me.alphamode.mcbig.math.BigDecimal choose(me.alphamode.mcbig.math.BigDecimal p_122492_, me.alphamode.mcbig.math.BigDecimal p_122493_, me.alphamode.mcbig.math.BigDecimal p_122494_) {
                return p_122492_;
            }
        ...
        Y("y") {
            ...
            @Override
            public me.alphamode.mcbig.math.BigInteger choose(me.alphamode.mcbig.math.BigInteger p_122510_, me.alphamode.mcbig.math.BigInteger p_122511_, me.alphamode.mcbig.math.BigInteger p_122512_) {
                return p_122511_;
            }
            ...
            @Override
            public me.alphamode.mcbig.math.BigDecimal choose(me.alphamode.mcbig.math.BigDecimal p_122506_, me.alphamode.mcbig.math.BigDecimal p_122507_, me.alphamode.mcbig.math.BigDecimal p_122508_) {
                return p_122507_;
            }
        ...
        Z("z") {
            ...
            @Override
            public me.alphamode.mcbig.math.BigInteger choose(me.alphamode.mcbig.math.BigInteger p_122524_, me.alphamode.mcbig.math.BigInteger p_122525_, me.alphamode.mcbig.math.BigInteger p_122526_) {
                return p_122526_;
            }
            ...
            @Override
            public me.alphamode.mcbig.math.BigDecimal choose(me.alphamode.mcbig.math.BigDecimal p_122520_, me.alphamode.mcbig.math.BigDecimal p_122521_, me.alphamode.mcbig.math.BigDecimal p_122522_) {
                return p_122522_;
            }
        ...
        public abstract me.alphamode.mcbig.math.BigInteger choose(me.alphamode.mcbig.math.BigInteger p_122466_, me.alphamode.mcbig.math.BigInteger p_122467_, me.alphamode.mcbig.math.BigInteger p_122468_);

        public abstract double choose(double p_122463_, double p_122464_, double p_122465_);

        public abstract me.alphamode.mcbig.math.BigDecimal choose(me.alphamode.mcbig.math.BigDecimal x, me.alphamode.mcbig.math.BigDecimal y, me.alphamode.mcbig.math.BigDecimal z);
    }
