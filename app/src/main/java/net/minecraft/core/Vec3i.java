...
public class Vec3i implements Comparable<Vec3i> {
    ...
    public int distChessboard(Vec3i p_381741_) {
        int i = Math.abs(this.getX() - p_381741_.getX());
        int j = Math.abs(this.getY() - p_381741_.getY());
        int k = Math.abs(this.getZ() - p_381741_.getZ());
    ...
    public me.alphamode.mcbig.core.Vec3l toVec3l() {
        return new me.alphamode.mcbig.core.Vec3l(getX(), getY(), getZ());
    }
}
