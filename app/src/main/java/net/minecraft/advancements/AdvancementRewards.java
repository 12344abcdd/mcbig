...
public record AdvancementRewards(int experience, List<ResourceKey<LootTable>> loot, List<ResourceKey<Recipe<?>>> recipes, Optional<CacheableFunction> function) {
        ...
        this.function
            ...
            .ifPresent(
                p_375403_ -> minecraftserver.getFunctions()
                        .execute((CommandFunction<CommandSourceStack>)p_375403_, p_9990_.createCommandSourceStack().withSuppressedOutput().withPermission(2))
            );
    }
    ...
    public static class Builder {
        ...
        public static AdvancementRewards.Builder recipe(ResourceKey<Recipe<?>> p_379571_) {
            return new AdvancementRewards.Builder().addRecipe(p_379571_);
        }

        public AdvancementRewards.Builder addRecipe(ResourceKey<Recipe<?>> p_380125_) {
            this.recipes.add(p_380125_);
            return this;
        }
