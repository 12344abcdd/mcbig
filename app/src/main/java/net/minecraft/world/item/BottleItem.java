...
public class BottleItem extends Item {
    ...
    public InteractionResult use(Level p_40656_, Player p_40657_, InteractionHand p_40658_) {
        List<AreaEffectCloud> list = p_40656_.getEntitiesOfClass(
            ...
            p_375973_ -> p_375973_ != null && p_375973_.isAlive() && p_375973_.getOwner() instanceof EnderDragon
        );
        ...
        if (!list.isEmpty()) {
            ...
            p_40656_.gameEvent(p_40657_, GameEvent.FLUID_PICKUP, p_40657_.bigPosition());
