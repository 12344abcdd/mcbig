...
public class BrushItem extends Item {
    ...
    private HitResult calculateHitResult(Player p_305856_) {
        return ProjectileUtil.getHitResultOnViewVector(p_305856_, EntitySelector.CAN_BE_PICKED, p_305856_.blockInteractionRange());
    }
    ...
    private void spawnDustParticles(Level p_278327_, BlockHitResult p_278272_, BlockState p_278235_, Vec3 p_278337_, HumanoidArm p_285071_) {
        ...
        me.alphamode.mcbig.core.BigVec3 vec3 = p_278272_.getLocation();

        for (int k = 0; k < j; k++) {
            p_278327_.addParticle(
                blockparticleoption,
                vec3.x.subtract((double)(direction == Direction.WEST ? 1.0E-6F : 0.0F)).doubleValue(),
                vec3.y,
                vec3.z.subtract((double)(direction == Direction.NORTH ? 1.0E-6F : 0.0F)).doubleValue(),
