...
public class InstrumentItem extends Item {
    ...
    private Optional<Holder<Instrument>> getInstrument(ItemStack p_220135_, HolderLookup.Provider p_365136_) {
        ...
        if (holder != null) {
            ...
            Optional<HolderSet.Named<Instrument>> optional = p_365136_.lookupOrThrow(Registries.INSTRUMENT).get(this.instruments);
            if (optional.isPresent()) {
    ...
    private static void play(Level p_220127_, Player p_220128_, Instrument p_220129_) {
        ...
        p_220127_.gameEvent(GameEvent.INSTRUMENT_PLAY, p_220128_.bigPosition(), GameEvent.Context.of(p_220128_));
    }
}
