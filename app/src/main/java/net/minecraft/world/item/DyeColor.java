...
public enum DyeColor implements StringRepresentable {
    ...
    public static DyeColor getMixedColor(ServerLevel p_386897_, DyeColor p_388832_, DyeColor p_386710_) {
        CraftingInput craftinginput = makeCraftColorInput(p_388832_, p_386710_);
        return p_386897_.recipeAccess()
            .getRecipeFor(RecipeType.CRAFTING, craftinginput, p_386897_)
            .map(p_386331_ -> p_386331_.value().assemble(craftinginput, p_386897_.registryAccess()))
            .map(ItemStack::getItem)
            .filter(DyeItem.class::isInstance)
            .map(DyeItem.class::cast)
            .map(DyeItem::getDyeColor)
            .orElseGet(() -> p_386897_.random.nextBoolean() ? p_388832_ : p_386710_);
    }

    private static CraftingInput makeCraftColorInput(DyeColor p_388241_, DyeColor p_387649_) {
        return CraftingInput.of(2, 1, List.of(new ItemStack(DyeItem.byColor(p_388241_)), new ItemStack(DyeItem.byColor(p_387649_))));
    }
}
