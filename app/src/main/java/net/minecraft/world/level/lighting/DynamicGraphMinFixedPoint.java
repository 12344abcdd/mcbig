...
public abstract class DynamicGraphMinFixedPoint<Pos> {
    ...
    private final LeveledPriorityQueue<Pos> priorityQueue;
    private final it.unimi.dsi.fastutil.objects.Object2ByteMap<Pos> computedLevels;
    ...
    protected DynamicGraphMinFixedPoint(int p_75543_, int p_75544_, final int p_75545_) {
        if (p_75543_ >= 254) {
            ...
            this.computedLevels = new it.unimi.dsi.fastutil.objects.Object2ByteOpenHashMap<>(p_75545_, 0.5F) {
                @Override
    ...
    protected void removeFromQueue(Pos p_75601_) {
        int i = this.computedLevels.removeByte(p_75601_) & 255;
        if (i != 255) {
    ...
    protected void checkNode(Pos p_75602_) {
    ...
    private void checkEdge(Pos p_75570_, Pos p_75571_, int p_75572_, int p_75573_, int p_75574_, boolean p_75575_) {
        if (!this.isSource(p_75571_)) {
            ...
            if (p_75573_ != i) {
                ...
                this.computedLevels.removeByte(p_75571_);
            }
        }
    }
    ...
    protected final int runUpdates(int p_75589_) {
        if (this.priorityQueue.isEmpty()) {
            ...
            while (!this.priorityQueue.isEmpty() && p_75589_ > 0) {
                p_75589_--;
                Pos i = this.priorityQueue.removeFirstLong();
