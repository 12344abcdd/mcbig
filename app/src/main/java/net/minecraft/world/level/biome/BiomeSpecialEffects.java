...
public class BiomeSpecialEffects {
    public static final Codec<BiomeSpecialEffects> CODEC = RecordCodecBuilder.create(
        p_382759_ -> p_382759_.group(
                    ...
                    Codec.FLOAT.fieldOf("music_volume").orElse(1.0F).forGetter(p_382760_ -> p_382760_.backgroundMusicVolume)
                )
                .apply(p_382759_, BiomeSpecialEffects::new)
    );
    ...
    BiomeSpecialEffects(
        ...
        this.backgroundMusicVolume = p_382783_;
    }
    ...
    public static class Builder {
        ...
        public BiomeSpecialEffects.Builder backgroundMusic(SimpleWeightedRandomList<Music> p_383133_) {
            this.backgroundMusic = Optional.of(p_383133_);
            return this;
        }

        public BiomeSpecialEffects.Builder backgroundMusicVolume(float p_382786_) {
            this.backgroundMusicVolume = p_382786_;
            return this;
        }
