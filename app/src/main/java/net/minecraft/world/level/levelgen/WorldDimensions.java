...
public record WorldDimensions(Map<ResourceKey<LevelStem>, LevelStem> dimensions) {
    ...
    public WorldDimensions replaceOverworldGenerator(HolderLookup.Provider p_364954_, ChunkGenerator p_248755_) {
        HolderLookup<DimensionType> holderlookup = p_364954_.lookupOrThrow(Registries.DIMENSION_TYPE);
    ...
    public static Map<ResourceKey<LevelStem>, LevelStem> withOverworld(
        HolderLookup<DimensionType> p_362725_, Map<ResourceKey<LevelStem>, LevelStem> p_326250_, ChunkGenerator p_250220_
    ) {
        LevelStem levelstem = p_326250_.get(LevelStem.OVERWORLD);
        Holder<DimensionType> holder = (Holder<DimensionType>)(levelstem == null ? p_362725_.getOrThrow(BuiltinDimensionTypes.OVERWORLD) : levelstem.type());
        return withOverworld(p_326250_, holder, p_250220_);
    }

    public static Map<ResourceKey<LevelStem>, LevelStem> withOverworld(
        Map<ResourceKey<LevelStem>, LevelStem> p_326287_, Holder<DimensionType> p_326403_, ChunkGenerator p_251737_
    ) {
        Builder<ResourceKey<LevelStem>, LevelStem> builder = ImmutableMap.builder();
        builder.putAll(p_326287_);
        builder.put(LevelStem.OVERWORLD, new LevelStem(p_326403_, p_251737_));
