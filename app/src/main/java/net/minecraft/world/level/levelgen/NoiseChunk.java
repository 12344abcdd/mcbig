...
public class NoiseChunk implements DensityFunction.ContextProvider, DensityFunction.FunctionContext {
    ...
    boolean fillingCell;
    private me.alphamode.mcbig.math.BigInteger cellStartBlockX = me.alphamode.mcbig.math.BigInteger.ZERO;
    int cellStartBlockY;
    private me.alphamode.mcbig.math.BigInteger cellStartBlockZ = me.alphamode.mcbig.math.BigInteger.ZERO;
    int inCellX;
    int inCellY;
    int inCellZ;
    ...
    public void advanceCellX(int p_188750_) {
        this.fillSlice(false, this.firstCellX.add(p_188750_ + 1));
    ...
    static class Cache2D implements DensityFunctions.MarkerOrMarked, NoiseChunk.NoiseChunkDensityFunction {
        ...
        public double compute(DensityFunction.FunctionContext p_209290_) {
            ...
            if (this.lastPos2D != null && this.lastPos2D.equals(k)) {
