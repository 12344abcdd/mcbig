...
public class ConcretePowderBlock extends FallingBlock {
    public static final MapCodec<ConcretePowderBlock> CODEC = RecordCodecBuilder.mapCodec(
        p_368415_ -> p_368415_.group(BuiltInRegistries.BLOCK.byNameCodec().fieldOf("concrete").forGetter(p_304618_ -> p_304618_.concrete), propertiesCodec())
                .apply(p_368415_, ConcretePowderBlock::new)
    );
    ...
    protected BlockState updateShape(
        ...
        return touchesLiquid(p_374245_, p_52078_)
