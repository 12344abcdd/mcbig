...
public class Target extends Node {
    ...
    public Target(me.alphamode.mcbig.math.BigInteger p_77498_, int p_77499_, me.alphamode.mcbig.math.BigInteger p_77500_) {
    ...
    public static Target createFromStream(FriendlyByteBuf p_77507_) {
        Target target = new Target(p_77507_.readBigInteger(), p_77507_.readInt(), p_77507_.readBigInteger());
