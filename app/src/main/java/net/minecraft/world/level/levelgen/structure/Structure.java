...
public abstract class Structure {
    ...
    public StructureStart generate(
        Holder<Structure> p_382890_,
        ResourceKey<Level> p_382876_,
        ...
        ProfiledDuration profiledduration = JvmProfiler.INSTANCE.onStructureGenerate(p_226603_, p_382876_, p_382890_);
    ...
    private static int[] getCornerHeights(Structure.GenerationContext p_226614_, me.alphamode.mcbig.math.BigInteger p_226615_, me.alphamode.mcbig.math.BigInteger p_226616_, me.alphamode.mcbig.math.BigInteger p_226617_, int p_226618_) {
    ...
    public static int getMeanFirstOccupiedHeight(Structure.GenerationContext p_341942_, me.alphamode.mcbig.math.BigInteger p_341930_, int p_341935_, me.alphamode.mcbig.math.BigInteger p_341884_, int p_341943_) {
        int[] aint = getCornerHeights(p_341942_, p_341930_, me.alphamode.mcbig.math.BigInteger.val(p_341935_), p_341884_, p_341943_);
    ...
    protected static int getLowestY(Structure.GenerationContext p_226573_, int p_226574_, int p_226575_) {
        ...
        me.alphamode.mcbig.math.BigInteger i = chunkpos.getMinBlockX();
        me.alphamode.mcbig.math.BigInteger j = chunkpos.getMinBlockZ();
        return getLowestY(p_226573_, i, j, me.alphamode.mcbig.math.BigInteger.val(p_226574_), p_226575_);
    }

    protected static int getLowestY(Structure.GenerationContext p_226577_, me.alphamode.mcbig.math.BigInteger p_226578_, me.alphamode.mcbig.math.BigInteger p_226579_, me.alphamode.mcbig.math.BigInteger p_226580_, int p_226581_) {
    ...
    protected BlockPos getLowestYIn5by5BoxOffset7Blocks(Structure.GenerationContext p_226583_, Rotation p_226584_) {
        ...
        return new BlockPos(k, getLowestY(p_226583_, k, l, me.alphamode.mcbig.math.BigInteger.val(i), j), l);
    }
    ...
    public static record StructureSettings(
        ...
        public static class Builder {
            ...
            public Builder(HolderSet<Biome> p_352136_) {
                ...
                this.biomes = p_352136_;
            }

            public Structure.StructureSettings.Builder spawnOverrides(Map<MobCategory, StructureSpawnOverride> p_352057_) {
                this.spawnOverrides = p_352057_;
                return this;
            }

            public Structure.StructureSettings.Builder generationStep(GenerationStep.Decoration p_352172_) {
                this.step = p_352172_;
                return this;
            }

            public Structure.StructureSettings.Builder terrainAdapation(TerrainAdjustment p_352176_) {
                this.terrainAdaption = p_352176_;
                return this;
            }
