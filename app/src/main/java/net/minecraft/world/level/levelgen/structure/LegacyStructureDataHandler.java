...
public class LegacyStructureDataHandler {
    ...
    public CompoundTag updateFromLegacy(CompoundTag p_71327_) {
        ...
        ChunkPos chunkpos = new ChunkPos(new me.alphamode.mcbig.math.BigInteger(compoundtag.getByteArray("xPos")), new me.alphamode.mcbig.math.BigInteger(compoundtag.getByteArray("zPos")));
    ...
    private boolean hasLegacyStart(me.alphamode.mcbig.math.BigInteger p_71315_, me.alphamode.mcbig.math.BigInteger p_71316_, String p_71317_) {
        return !this.hasLegacyData
            ? false
            : this.dataMap.get(p_71317_) != null && this.indexMap.get(CURRENT_TO_LEGACY_MAP.get(p_71317_)).hasStartIndex(new ChunkPos(p_71315_, p_71316_));
    }
            ...
            for (String s : this.legacyKeys) {
                ...
                if (structurefeatureindexsaveddata.getAll().isEmpty()) {
                    ...
                    for (String s2 : compoundtag.getAllKeys()) {
                        ...
                        structurefeatureindexsaveddata1.addIndex(new ChunkPos(new me.alphamode.mcbig.math.BigInteger(compoundtag2.getByteArray("ChunkX")), new me.alphamode.mcbig.math.BigInteger(compoundtag2.getByteArray("ChunkZ"))));
                    }
                } else {
