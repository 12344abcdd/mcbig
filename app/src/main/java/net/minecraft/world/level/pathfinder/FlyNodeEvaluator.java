...
public class FlyNodeEvaluator extends WalkNodeEvaluator {
    private final it.unimi.dsi.fastutil.objects.Object2ObjectMap<BlockPos, PathType> pathTypeByPosCache = new it.unimi.dsi.fastutil.objects.Object2ObjectOpenHashMap<>();
    ...
    protected boolean canStartAt(BlockPos p_262645_) {
        PathType pathtype = this.getCachedPathType(p_262645_.getBigX(), p_262645_.getY(), p_262645_.getBigZ());
    ...
    public int getNeighbors(Node[] p_77266_, Node p_77267_) {
        ...
        Node node6 = this.findAcceptedNode(p_77267_.x, p_77267_.y + 1, p_77267_.z.add());
        if (this.isOpen(node6) && this.hasMalus(node) && this.hasMalus(node4)) {
            p_77266_[i++] = node6;
        }

        Node node7 = this.findAcceptedNode(p_77267_.x.subtract(), p_77267_.y + 1, p_77267_.z);
        if (this.isOpen(node7) && this.hasMalus(node1) && this.hasMalus(node4)) {
            p_77266_[i++] = node7;
        }

        Node node8 = this.findAcceptedNode(p_77267_.x.add(), p_77267_.y + 1, p_77267_.z);
        if (this.isOpen(node8) && this.hasMalus(node2) && this.hasMalus(node4)) {
            p_77266_[i++] = node8;
        }

        Node node9 = this.findAcceptedNode(p_77267_.x, p_77267_.y + 1, p_77267_.z.subtract());
        if (this.isOpen(node9) && this.hasMalus(node3) && this.hasMalus(node4)) {
            p_77266_[i++] = node9;
        }

        Node node10 = this.findAcceptedNode(p_77267_.x, p_77267_.y - 1, p_77267_.z.add());
        if (this.isOpen(node10) && this.hasMalus(node) && this.hasMalus(node5)) {
            p_77266_[i++] = node10;
        }

        Node node11 = this.findAcceptedNode(p_77267_.x.subtract(), p_77267_.y - 1, p_77267_.z);
        if (this.isOpen(node11) && this.hasMalus(node1) && this.hasMalus(node5)) {
            p_77266_[i++] = node11;
        }

        Node node12 = this.findAcceptedNode(p_77267_.x.add(), p_77267_.y - 1, p_77267_.z);
        if (this.isOpen(node12) && this.hasMalus(node2) && this.hasMalus(node5)) {
            p_77266_[i++] = node12;
        }

        Node node13 = this.findAcceptedNode(p_77267_.x, p_77267_.y - 1, p_77267_.z.subtract());
        ...
        Node node18 = this.findAcceptedNode(p_77267_.x.add(), p_77267_.y + 1, p_77267_.z.subtract());
        ...
        Node node19 = this.findAcceptedNode(p_77267_.x.add(), p_77267_.y + 1, p_77267_.z.add());
        ...
        Node node20 = this.findAcceptedNode(p_77267_.x.subtract(), p_77267_.y + 1, p_77267_.z.subtract());
        ...
        Node node21 = this.findAcceptedNode(p_77267_.x.subtract(), p_77267_.y + 1, p_77267_.z.add());
        ...
        Node node22 = this.findAcceptedNode(p_77267_.x.add(), p_77267_.y - 1, p_77267_.z.subtract());
        ...
        Node node23 = this.findAcceptedNode(p_77267_.x.add(), p_77267_.y - 1, p_77267_.z.add());
        ...
        Node node24 = this.findAcceptedNode(p_77267_.x.subtract(), p_77267_.y - 1, p_77267_.z.subtract());
        ...
        Node node25 = this.findAcceptedNode(p_77267_.x.subtract(), p_77267_.y - 1, p_77267_.z.add());
    ...
    @Nullable
    protected Node findAcceptedNode(me.alphamode.mcbig.math.BigInteger p_262970_, int p_263018_, me.alphamode.mcbig.math.BigInteger p_262947_) {
        Node node = null;
    ...
    @Override
    protected PathType getCachedPathType(me.alphamode.mcbig.math.BigInteger p_326867_, int p_326833_, me.alphamode.mcbig.math.BigInteger p_326788_) {
        return this.pathTypeByPosCache
                .computeIfAbsent(
                        new BlockPos(p_326867_, p_326833_, p_326788_),
                        p_330153_ -> this.getPathTypeOfMob(this.currentContext, p_326867_, p_326833_, p_326788_, this.mob)
                );
    }

    @Override
    public PathType getPathType(PathfindingContext p_331058_, me.alphamode.mcbig.math.BigInteger p_77246_, int p_77247_, me.alphamode.mcbig.math.BigInteger p_77248_) {
        ...
        if (pathtype == PathType.OPEN && p_77247_ >= p_331058_.level().getMinY() + 1) {
            ...
            PathType pathtype1 = p_331058_.getPathTypeFromState(blockpos.getBigX(), blockpos.getY(), blockpos.getBigZ());
