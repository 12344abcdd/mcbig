...
public class NetherFossilStructure extends Structure {
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext p_228576_) {
        ...
        me.alphamode.mcbig.math.BigInteger i = p_228576_.chunkPos().getMinBlockX().add(worldgenrandom.nextInt(16));
        me.alphamode.mcbig.math.BigInteger j = p_228576_.chunkPos().getMinBlockZ().add(worldgenrandom.nextInt(16));
