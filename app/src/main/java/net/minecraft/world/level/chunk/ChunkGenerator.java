...
public abstract class ChunkGenerator {
                    ...
                    if (structureplacement.isStructureChunk(p_256505_, chunkpos.x, chunkpos.z)) {
                        if (list.size() == 1) {
                            this.tryGenerateStructure(
                                list.get(0), p_255934_, p_255835_, randomstate, p_255832_, p_256505_.getLevelSeed(), p_255767_, chunkpos, sectionpos, p_383210_
                            );
                        } else {
    ...
    private boolean tryGenerateStructure(
        ...
        StructureStart structurestart = structure.generate(
            p_223105_.structure(), p_383135_, p_223107_, this, this.biomeSource, p_223108_, p_223109_, p_223110_, p_223112_, i, p_223111_, predicate
        );
    ...
    public void createReferences(WorldGenLevel p_223077_, StructureManager p_223078_, ChunkAccess p_223079_) {
        ...
        me.alphamode.mcbig.math.BigInteger l = chunkpos.getMinBlockX();
        me.alphamode.mcbig.math.BigInteger i1 = chunkpos.getMinBlockZ();
