...
public class StructureManager {
    ...
    public void fillStartsForStructure(Structure p_220481_, it.unimi.dsi.fastutil.objects.ObjectSet<ChunkPos> p_220482_, Consumer<StructureStart> p_220483_) {
        for(ChunkPos i : p_220482_) {
            SectionPos sectionpos = SectionPos.of(i, this.level.getMinSectionY());
    ...
    public StructureStart getStructureWithPieceAt(BlockPos p_220489_, Predicate<Holder<Structure>> p_332144_) {
        ...
        for (StructureStart structurestart : this.startsForStructure(
            new ChunkPos(p_220489_), p_367976_ -> registry.get(registry.getId(p_367976_)).map(p_332144_::test).orElse(false)
        )) {
