...
public class TallGrassBlock extends BushBlock implements BonemealableBlock {
    ...
    private static DoublePlantBlock getGrownBlock(BlockState p_363948_) {
        return (DoublePlantBlock)(p_363948_.is(Blocks.FERN) ? Blocks.LARGE_FERN : Blocks.TALL_GRASS);
    }
}
