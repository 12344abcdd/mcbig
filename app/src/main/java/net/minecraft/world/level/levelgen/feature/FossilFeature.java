...
public class FossilFeature extends Feature<FossilFeatureConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<FossilFeatureConfiguration> p_159789_) {
        ...
        BoundingBox boundingbox = new BoundingBox(
            chunkpos.getMinBlockX().subtract(me.alphamode.mcbig.core.BigConstants.Ints.SIXTEEN),
            worldgenlevel.getMinY(),
            chunkpos.getMinBlockZ().subtract(me.alphamode.mcbig.core.BigConstants.Ints.SIXTEEN),
            chunkpos.getMaxBlockX().add(me.alphamode.mcbig.core.BigConstants.Ints.SIXTEEN),
            worldgenlevel.getMaxY(),
            chunkpos.getMaxBlockZ().add(me.alphamode.mcbig.core.BigConstants.Ints.SIXTEEN)
        );
    ...
    private static int countEmptyCorners(WorldGenLevel p_159782_, BoundingBox p_159783_) {
        ...
        p_159783_.forAllCorners(p_360239_ -> {
            BlockState blockstate = p_159782_.getBlockState(p_360239_);
