...
public class JigsawPlacement {
    ...
    public static Optional<Structure.GenerationStub> addPieces(
        ...
        DimensionPadding p_348489_,
        LiquidSettings p_352161_
    ) {
        ...
        if (structurepoolelement == EmptyPoolElement.INSTANCE) {
            ...
            poolelementstructurepiece.move(me.alphamode.mcbig.math.BigInteger.ZERO, me.alphamode.mcbig.math.BigInteger.val(k - l), me.alphamode.mcbig.math.BigInteger.ZERO);
            if (isStartTooCloseToWorldHeightLimits(levelheightaccessor, p_348489_, poolelementstructurepiece.getBoundingBox())) {
                LOGGER.debug(
                        ...
                        p_352014_ -> {
                            ...
                            if (p_227242_ > 0) {
                                AABB aabb = new AABB(
                                    ...
                                    (double)Math.max(i1 - p_227246_, levelheightaccessor.getMinY() + p_348489_.bottom()),
                                    (double)(j.subtract(p_227246_)).doubleValue(),
                                    (double)(i.add(p_227246_ + 1)).doubleValue(),
                                    (double)Math.min(i1 + p_227246_ + 1, levelheightaccessor.getMaxY() + 1 - p_348489_.top()),
                                    (double)(j.add(p_227246_ + 1)).doubleValue()
                                );
    ...
    private static boolean isStartTooCloseToWorldHeightLimits(LevelHeightAccessor p_383116_, DimensionPadding p_382835_, BoundingBox p_383171_) {
        if (p_382835_ == DimensionPadding.ZERO) {
            ...
            int i = p_383116_.getMinY() + p_382835_.bottom();
            int j = p_383116_.getMaxY() - p_382835_.top();
            return p_383171_.minY().intValue() < i || p_383171_.maxY().intValue() > j;
        }
    }
    ...
    private static void addPieces(
        ...
        jigsawplacement$placer.tryPlacingChildren(p_227219_, new MutableObject<>(p_227221_), 0, p_227213_, p_227216_, p_227211_, p_307210_, p_352331_);
    ...
    static final class Placer {
        ...
        void tryPlacingChildren(
            ...
            for (StructureTemplate.JigsawBlockInfo structuretemplate$jigsawblockinfo : structurepoolelement.getShuffledJigsawBlocks(
                ...
                ResourceKey<StructureTemplatePool> resourcekey = readPoolKey(structuretemplate$jigsawblockinfo, p_307643_);
                                            ...
                                            .mapToInt(
                                                p_379284_ -> {
                                                    ...
                                                    if (!boundingbox1.isInside(
                                                        ...
                                                        ResourceKey<StructureTemplatePool> resourcekey1 = readPoolKey(p_379284_, p_307643_);
                                    ...
                                    for (StructureTemplate.JigsawBlockInfo structuretemplate$jigsawblockinfo1 : list1) {
                                        if (JigsawBlock.canAttach(structuretemplate$jigsawblockinfo, structuretemplate$jigsawblockinfo1)) {
                                            ...
                                            if (!Shapes.joinIsNotEmpty(
                                                ...
                                                PoolElementStructurePiece poolelementstructurepiece = new PoolElementStructurePiece(
                                                    this.structureTemplateManager, structurepoolelement1, blockpos5, l2, rotation1, boundingbox3, p_352442_
                                                );
                                                int i3;
                                                if (flag) {
                                                    i3 = i + j;
        ...
        private static ResourceKey<StructureTemplatePool> readPoolKey(StructureTemplate.JigsawBlockInfo p_380127_, PoolAliasLookup p_307490_) {
            return p_307490_.lookup(Pools.createKey(p_380127_.pool()));
        }
    }
}
