...
public class LecternBlockEntity extends BlockEntity implements Clearable, MenuProvider {
    ...
    private CommandSourceStack createCommandSourceStack(@Nullable Player p_59535_, ServerLevel p_373006_) {
        ...
        me.alphamode.mcbig.core.BigVec3 vec3 = me.alphamode.mcbig.core.BigVec3.atCenterOf(this.worldPosition);
        return new CommandSourceStack(CommandSource.NULL, vec3, Vec2.ZERO, p_373006_, 2, s, component, p_373006_.getServer(), p_59535_);
    }
