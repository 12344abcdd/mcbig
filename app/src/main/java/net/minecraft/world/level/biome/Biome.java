...
public final class Biome {
    ...
    public Biome.Precipitation getPrecipitationAt(BlockPos p_265163_, int p_361844_) {
        if (!this.hasPrecipitation()) {
            return Biome.Precipitation.NONE;
        } else {
            return this.coldEnoughToSnow(p_265163_, p_361844_) ? Biome.Precipitation.SNOW : Biome.Precipitation.RAIN;
        }
    }

    private float getHeightAdjustedTemperature(BlockPos p_47529_, int p_363138_) {
    ...
    @Deprecated
    private float getTemperature(BlockPos p_47506_, int p_365137_) {
//        long i = p_47506_.asLong();
        ...
        if (!Float.isNaN(f)) {
            ...
            float f1 = this.getHeightAdjustedTemperature(p_47506_, p_365137_);
    ...
    public boolean coldEnoughToSnow(BlockPos p_198905_, int p_361315_) {
        return !this.warmEnoughToRain(p_198905_, p_361315_);
    }

    public boolean warmEnoughToRain(BlockPos p_198907_, int p_362250_) {
        return this.getTemperature(p_198907_, p_362250_) >= 0.15F;
    }

    public boolean shouldMeltFrozenOceanIcebergSlightly(BlockPos p_198909_, int p_360933_) {
        return this.getTemperature(p_198909_, p_360933_) > 0.1F;
    }
