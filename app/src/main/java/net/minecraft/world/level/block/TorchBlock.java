...
public class TorchBlock extends BaseTorchBlock {
    ...
    public static final MapCodec<TorchBlock> CODEC = RecordCodecBuilder.mapCodec(
        p_368442_ -> p_368442_.group(PARTICLE_OPTIONS_FIELD.forGetter(p_304762_ -> p_304762_.flameParticle), propertiesCodec())
                .apply(p_368442_, TorchBlock::new)
    );
    ...
    protected TorchBlock(SimpleParticleType p_304940_, BlockBehaviour.Properties p_57491_) {
        super(p_57491_);
