...
public abstract class AbstractSkeleton extends Monster implements RangedAttackMob {
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_32146_, DifficultyInstance p_32147_, EntitySpawnReason p_362962_, @Nullable SpawnGroupData p_32149_
    ) {
        p_32149_ = super.finalizeSpawn(p_32146_, p_32147_, p_362962_, p_32149_);
