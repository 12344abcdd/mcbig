...
public class BreezeWindCharge extends AbstractWindCharge {
    ...
    public BreezeWindCharge(Breeze p_326239_, Level p_326041_) {
        super(EntityType.BREEZE_WIND_CHARGE, p_326041_, p_326239_, p_326239_.getX(), p_326239_.getFiringYPosition(), p_326239_.getZ());
    }

    @Override
    protected void explode(me.alphamode.mcbig.core.BigVec3 p_352274_) {
        this.level()
            .explode(
                this,
                null,
