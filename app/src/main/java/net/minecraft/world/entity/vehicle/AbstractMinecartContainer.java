...
public abstract class AbstractMinecartContainer extends AbstractMinecart implements ContainerEntity {
    ...
    @Override
    public void destroy(ServerLevel p_376786_, DamageSource p_38228_) {
        super.destroy(p_376786_, p_38228_);
        this.chestVehicleDestroyed(p_38228_, p_376786_, this);
    }
    ...
    @Override
    protected Vec3 applyNaturalSlowdown(Vec3 p_365520_) {
        float f = 0.98F;
        ...
        return p_365520_.multiply((double)f, 0.0, (double)f);
    }
    ...
    @Override
    public void setContainerLootTable(@Nullable ResourceKey<LootTable> p_336075_) {
