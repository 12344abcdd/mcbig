...
public class Husk extends Zombie {
    ...
    public static boolean checkHuskSpawnRules(
        EntityType<Husk> p_218997_, ServerLevelAccessor p_218998_, EntitySpawnReason p_363377_, BlockPos p_219000_, RandomSource p_219001_
    ) {
        return checkMonsterSpawnRules(p_218997_, p_218998_, p_363377_, p_219000_, p_219001_)
            && (EntitySpawnReason.isSpawner(p_363377_) || p_218998_.canSeeSky(p_219000_));
    }
