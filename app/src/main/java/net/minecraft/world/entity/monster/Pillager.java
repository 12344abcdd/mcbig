...
public class Pillager extends AbstractIllager implements CrossbowAttackMob, InventoryCarrier {
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_33282_, DifficultyInstance p_33283_, EntitySpawnReason p_363547_, @Nullable SpawnGroupData p_33285_
    ) {
        ...
        return super.finalizeSpawn(p_33282_, p_33283_, p_363547_, p_33285_);
    }
    ...
    @Override
    protected void pickUpItem(ServerLevel p_376414_, ItemEntity p_33296_) {
        ItemStack itemstack = p_33296_.getItem();
        if (itemstack.getItem() instanceof BannerItem) {
            super.pickUpItem(p_376414_, p_33296_);
