...
public abstract class Monster extends PathfinderMob implements Enemy {
    ...
    public static boolean checkMonsterSpawnRules(
        ...
        return p_219015_.getDifficulty() != Difficulty.PEACEFUL
            ...
            && checkMobSpawnRules(p_219014_, p_219015_, p_361180_, p_219017_, p_219018_);
    }

    public static boolean checkAnyLightMonsterSpawnRules(
        EntityType<? extends Monster> p_219020_, LevelAccessor p_219021_, EntitySpawnReason p_361640_, BlockPos p_219023_, RandomSource p_219024_
    ) {
        return p_219021_.getDifficulty() != Difficulty.PEACEFUL && checkMobSpawnRules(p_219020_, p_219021_, p_361640_, p_219023_, p_219024_);
    }
