...
public class Creaking extends Monster {
    ...
    class HomeNodeEvaluator extends WalkNodeEvaluator {
        ...
        @Override
        public PathType getPathType(PathfindingContext p_389549_, me.alphamode.mcbig.math.BigInteger p_389638_, int p_389512_, me.alphamode.mcbig.math.BigInteger p_389613_) {
            BlockPos blockpos = Creaking.this.getHomePos();
            if (blockpos == null) {
                return super.getPathType(p_389549_, p_389638_, p_389512_, p_389613_);
            } else {
                double d0 = blockpos.distSqr(new me.alphamode.mcbig.core.Vec3l(p_389638_, p_389512_, p_389613_));
