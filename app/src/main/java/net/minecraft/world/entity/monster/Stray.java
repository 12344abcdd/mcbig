...
public class Stray extends AbstractSkeleton {
    ...
    public static boolean checkStraySpawnRules(
        EntityType<Stray> p_219121_, ServerLevelAccessor p_219122_, EntitySpawnReason p_360760_, BlockPos p_219124_, RandomSource p_219125_
    ) {
        ...
        return checkMonsterSpawnRules(p_219121_, p_219122_, p_360760_, p_219124_, p_219125_)
            && (EntitySpawnReason.isSpawner(p_360760_) || p_219122_.canSeeSky(blockpos.below()));
    }
