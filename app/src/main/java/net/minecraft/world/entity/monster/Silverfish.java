...
public class Silverfish extends Monster {
    ...
    public static boolean checkSilverfishSpawnRules(
        EntityType<Silverfish> p_219077_, LevelAccessor p_219078_, EntitySpawnReason p_362159_, BlockPos p_219080_, RandomSource p_219081_
    ) {
        if (!checkAnyLightMonsterSpawnRules(p_219077_, p_219078_, p_362159_, p_219080_, p_219081_)) {
            return false;
        } else if (EntitySpawnReason.isSpawner(p_362159_)) {
            return true;
        } else {
