...
public class SnowGolem extends AbstractGolem implements Shearable, RangedAttackMob {
    ...
    public void performRangedAttack(LivingEntity p_29912_, float p_29913_) {
        ...
        if (this.level() instanceof ServerLevel serverlevel) {
            ...
            Projectile.spawnProjectile(
                ...
                serverlevel,
                itemstack,
                p_390225_ -> p_390225_.shoot(d0, d1 + d3 - p_390225_.getY(), d2, 1.6F, 12.0F)
            );
        }
    ...
    @Override
    public void shear(ServerLevel p_376257_, SoundSource p_29907_, ItemStack p_373004_) {
        p_376257_.playSound(null, this, SoundEvents.SNOW_GOLEM_SHEAR, p_29907_, 1.0F, 1.0F);
        this.setPumpkin(false);
        this.dropFromShearingLootTable(
            p_376257_, BuiltInLootTables.SHEAR_SNOW_GOLEM, p_373004_, (p_375823_, p_375824_) -> this.spawnAtLocation(p_375823_, p_375824_, this.getEyeHeight())
        );
    }
