...
public class DragonLandingApproachPhase extends AbstractDragonPhaseInstance {
    ...
    private void findNewTarget(ServerLevel p_376362_) {
        if (this.currentPath == null || this.currentPath.isDone()) {
            int i = this.dragon.findClosestNode();
            BlockPos blockpos = p_376362_.getHeightmapPos(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, EndPodiumFeature.getLocation(this.dragon.getFightOrigin()));
            Player player = p_376362_.getNearestPlayer(
            ...
            Node node = new Node(blockpos.getBigX(), blockpos.getY(), blockpos.getBigZ());
