...
public class Parrot extends ShoulderRidingEntity implements VariantHolder<Parrot.Variant>, FlyingAnimal {
    ...
    static final Map<EntityType<?>, SoundEvent> MOB_SOUND_MAP = Util.make(Maps.newHashMap(), p_389382_ -> {
        ...
        p_389382_.put(EntityType.BREEZE, SoundEvents.PARROT_IMITATE_BREEZE);
        p_389382_.put(EntityType.CAVE_SPIDER, SoundEvents.PARROT_IMITATE_SPIDER);
        p_389382_.put(EntityType.CREAKING, SoundEvents.PARROT_IMITATE_CREAKING);
        p_389382_.put(EntityType.CREEPER, SoundEvents.PARROT_IMITATE_CREEPER);
        p_389382_.put(EntityType.DROWNED, SoundEvents.PARROT_IMITATE_DROWNED);
        p_389382_.put(EntityType.ELDER_GUARDIAN, SoundEvents.PARROT_IMITATE_ELDER_GUARDIAN);
        p_389382_.put(EntityType.ENDER_DRAGON, SoundEvents.PARROT_IMITATE_ENDER_DRAGON);
        p_389382_.put(EntityType.ENDERMITE, SoundEvents.PARROT_IMITATE_ENDERMITE);
        p_389382_.put(EntityType.EVOKER, SoundEvents.PARROT_IMITATE_EVOKER);
        p_389382_.put(EntityType.GHAST, SoundEvents.PARROT_IMITATE_GHAST);
        p_389382_.put(EntityType.GUARDIAN, SoundEvents.PARROT_IMITATE_GUARDIAN);
        p_389382_.put(EntityType.HOGLIN, SoundEvents.PARROT_IMITATE_HOGLIN);
        p_389382_.put(EntityType.HUSK, SoundEvents.PARROT_IMITATE_HUSK);
        p_389382_.put(EntityType.ILLUSIONER, SoundEvents.PARROT_IMITATE_ILLUSIONER);
        p_389382_.put(EntityType.MAGMA_CUBE, SoundEvents.PARROT_IMITATE_MAGMA_CUBE);
        p_389382_.put(EntityType.PHANTOM, SoundEvents.PARROT_IMITATE_PHANTOM);
        p_389382_.put(EntityType.PIGLIN, SoundEvents.PARROT_IMITATE_PIGLIN);
        p_389382_.put(EntityType.PIGLIN_BRUTE, SoundEvents.PARROT_IMITATE_PIGLIN_BRUTE);
        p_389382_.put(EntityType.PILLAGER, SoundEvents.PARROT_IMITATE_PILLAGER);
        p_389382_.put(EntityType.RAVAGER, SoundEvents.PARROT_IMITATE_RAVAGER);
        p_389382_.put(EntityType.SHULKER, SoundEvents.PARROT_IMITATE_SHULKER);
        p_389382_.put(EntityType.SILVERFISH, SoundEvents.PARROT_IMITATE_SILVERFISH);
        p_389382_.put(EntityType.SKELETON, SoundEvents.PARROT_IMITATE_SKELETON);
        p_389382_.put(EntityType.SLIME, SoundEvents.PARROT_IMITATE_SLIME);
        p_389382_.put(EntityType.SPIDER, SoundEvents.PARROT_IMITATE_SPIDER);
        p_389382_.put(EntityType.STRAY, SoundEvents.PARROT_IMITATE_STRAY);
        p_389382_.put(EntityType.VEX, SoundEvents.PARROT_IMITATE_VEX);
        p_389382_.put(EntityType.VINDICATOR, SoundEvents.PARROT_IMITATE_VINDICATOR);
        p_389382_.put(EntityType.WARDEN, SoundEvents.PARROT_IMITATE_WARDEN);
        p_389382_.put(EntityType.WITCH, SoundEvents.PARROT_IMITATE_WITCH);
        p_389382_.put(EntityType.WITHER, SoundEvents.PARROT_IMITATE_WITHER);
        p_389382_.put(EntityType.WITHER_SKELETON, SoundEvents.PARROT_IMITATE_WITHER_SKELETON);
        p_389382_.put(EntityType.ZOGLIN, SoundEvents.PARROT_IMITATE_ZOGLIN);
        p_389382_.put(EntityType.ZOMBIE, SoundEvents.PARROT_IMITATE_ZOMBIE);
        p_389382_.put(EntityType.ZOMBIE_VILLAGER, SoundEvents.PARROT_IMITATE_ZOMBIE_VILLAGER);
    });
    public float flap;
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_29389_, DifficultyInstance p_29390_, EntitySpawnReason p_365194_, @Nullable SpawnGroupData p_29392_
    ) {
        ...
        return super.finalizeSpawn(p_29389_, p_29390_, p_365194_, p_29392_);
    }
    ...
    public static boolean checkParrotSpawnRules(
        EntityType<Parrot> p_218242_, LevelAccessor p_218243_, EntitySpawnReason p_360625_, BlockPos p_218245_, RandomSource p_218246_
    ) {
    ...
    @Override
    public boolean hurtServer(ServerLevel p_376162_, DamageSource p_376903_, float p_376601_) {
        if (this.isInvulnerableTo(p_376162_, p_376903_)) {
            return false;
        } else {
            this.setOrderedToSit(false);
            return super.hurtServer(p_376162_, p_376903_, p_376601_);
        }
    }
