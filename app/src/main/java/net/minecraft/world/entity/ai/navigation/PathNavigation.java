...
public abstract class PathNavigation {
    ...
    public void setRequiredPathLength(float p_362938_) {
        this.requiredPathLength = p_362938_;
    ...
    public boolean shouldRecomputePath(BlockPos p_200904_) {
        if (this.hasDelayedRecomputation) {
            ...
            Vec3 vec3 = new Vec3(((double)node.x.doubleValue() + this.mob.getX()) / 2.0, ((double)node.y + this.mob.getY()) / 2.0, ((double)node.z.doubleValue() + this.mob.getZ()) / 2.0);
