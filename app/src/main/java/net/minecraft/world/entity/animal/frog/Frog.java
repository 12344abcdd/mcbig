...
public class Frog extends Animal implements VariantHolder<Holder<FrogVariant>> {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_326194_) {
        ...
        p_326194_.define(DATA_VARIANT_ID, BuiltInRegistries.FROG_VARIANT.getOrThrow(DEFAULT_VARIANT));
    ...
    static class FrogNodeEvaluator extends AmphibiousNodeEvaluator {
        ...
        @Override
        public PathType getPathType(PathfindingContext p_331446_, me.alphamode.mcbig.math.BigInteger p_326799_, int p_326899_, me.alphamode.mcbig.math.BigInteger p_326891_) {
