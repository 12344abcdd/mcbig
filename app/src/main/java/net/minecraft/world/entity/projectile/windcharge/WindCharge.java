...
public class WindCharge extends AbstractWindCharge {
    ...
    @Override
    protected void explode(me.alphamode.mcbig.core.BigVec3 p_352393_) {
        this.level()
            .explode(
                this,
                null,
    ...
    @Override
    public boolean shouldRenderAtSqrDistance(double p_363611_) {
        return this.tickCount < 2 && p_363611_ < (double)MIN_CAMERA_DISTANCE_SQUARED ? false : super.shouldRenderAtSqrDistance(p_363611_);
    }
}
