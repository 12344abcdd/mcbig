...
public class Illusioner extends SpellcasterIllager implements RangedAttackMob {
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_32921_, DifficultyInstance p_32922_, EntitySpawnReason p_365326_, @Nullable SpawnGroupData p_32924_
    ) {
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(Items.BOW));
        return super.finalizeSpawn(p_32921_, p_32922_, p_365326_, p_32924_);
    }
