...
public abstract class Raider extends PatrollingMonster {
    ...
    static final Predicate<ItemEntity> ALLOWED_ITEMS = p_390292_ -> !p_390292_.hasPickUpDelay()
            && p_390292_.isAlive()
            && ItemStack.matches(p_390292_.getItem(), Raid.getOminousBannerInstance(p_390292_.registryAccess().lookupOrThrow(Registries.BANNER_PATTERN)));
    @Nullable
    protected Raid raid;
    private int wave;
    ...
    static class RaiderMoveThroughVillageGoal extends Goal {
        ...
        public void start() {
            ...
            this.raider.getNavigation().moveTo((double)this.poiPos.getBigX().doubleValue(), (double)this.poiPos.getBigY().doubleValue(), (double)this.poiPos.getBigZ().doubleValue(), this.speedModifier);
            this.stuck = false;
        }
