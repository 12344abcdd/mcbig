...
public class DragonHoldingPatternPhase extends AbstractDragonPhaseInstance {
    ...
    private void findNewTarget(ServerLevel p_376816_) {
        if (this.currentPath != null && this.currentPath.isDone()) {
            BlockPos blockpos = p_376816_.getHeightmapPos(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, EndPodiumFeature.getLocation(this.dragon.getFightOrigin()));
            ...
            Player player = p_376816_.getNearestPlayer(
