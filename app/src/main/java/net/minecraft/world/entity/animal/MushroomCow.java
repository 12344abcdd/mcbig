...
public class MushroomCow extends Cow implements Shearable, VariantHolder<MushroomCow.Variant> {
    ...
    public static boolean checkMushroomSpawnRules(
        EntityType<MushroomCow> p_218201_, LevelAccessor p_218202_, EntitySpawnReason p_360426_, BlockPos p_218204_, RandomSource p_218205_
    ) {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_326279_) {
        ...
        p_326279_.define(DATA_TYPE, MushroomCow.Variant.RED.type);
    }
    ...
    public void setVariant(MushroomCow.Variant p_360882_) {
    ...
    public static enum Variant implements StringRepresentable {
        ...
        static MushroomCow.Variant byName(String p_364149_) {
            return CODEC.byName(p_364149_, RED);
        }
    }
}
