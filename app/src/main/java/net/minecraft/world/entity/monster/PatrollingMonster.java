...
public abstract class PatrollingMonster extends Monster {
    ...
    public void readAdditionalSaveData(CompoundTag p_33055_) {
        ...
        NbtUtils.readBlockPos(p_33055_, "patrol_target").ifPresent(p_326234_ -> this.patrolTarget = p_326234_);
    ...
    public static boolean checkPatrollingMonsterSpawnRules(
        EntityType<? extends PatrollingMonster> p_219026_, LevelAccessor p_219027_, EntitySpawnReason p_361513_, BlockPos p_219029_, RandomSource p_219030_
    ) {
        return p_219027_.getBrightness(LightLayer.BLOCK, p_219029_) > 8
            ? false
            : checkAnyLightMonsterSpawnRules(p_219026_, p_219027_, p_361513_, p_219029_, p_219030_);
    }
    ...
    public static class LongDistancePatrolGoal<T extends PatrollingMonster> extends Goal {
        ...
        private List<PatrollingMonster> findPatrolCompanions() {
            return this.mob
                .level()
                .getEntitiesOfClass(
                    PatrollingMonster.class, this.mob.getBoundingBox().inflate(16.0), p_359927_ -> p_359927_.canJoinPatrol() && !p_359927_.is(this.mob)
                );
        }
