...
public class Slime extends Mob implements Enemy {
        ...
        this.targetSelector
            .addGoal(
                ...
                new NearestAttackableTargetGoal<>(
                    this, Player.class, 10, true, false, (p_390245_, p_390246_) -> Math.abs(p_390245_.getY() - this.getY()) <= 4.0
                )
            );
    ...
    public static boolean checkSlimeSpawnRules(
        EntityType<Slime> p_219113_, LevelAccessor p_219114_, EntitySpawnReason p_363569_, BlockPos p_219116_, RandomSource p_219117_
    ) {
        if (p_219114_.getDifficulty() != Difficulty.PEACEFUL) {
            if (EntitySpawnReason.isSpawner(p_363569_)) {
                return checkMobSpawnRules(p_219113_, p_219114_, p_363569_, p_219116_, p_219117_);
            }
