...
public class EnderDragon extends Mob implements Enemy {
        ...
        for (Entity entity : p_31132_) {
            if (entity instanceof LivingEntity) {
                ...
                if (!this.phaseManager.getCurrentPhase().isSitting() && livingentity.getLastHurtByMobTimestamp() < entity.tickCount - 2) {
                    ...
                    entity.hurtServer(p_345435_, damagesource, 5.0F);
    ...
    private void hurt(ServerLevel p_376494_, List<Entity> p_31142_) {
        for (Entity entity : p_31142_) {
            if (entity instanceof LivingEntity) {
                DamageSource damagesource = this.damageSources().mobAttack(this);
                entity.hurtServer(p_376494_, damagesource, 10.0F);
                EnchantmentHelper.doPostAttackEffects(p_376494_, entity, damagesource);
            }
        }
    }
    ...
    private boolean checkWalls(ServerLevel p_376795_, AABB p_31140_) {
        ...
        if (flag1) {
            ...
            p_376795_.levelEvent(2008, blockpos1, 0);
        }

        return flag;
    }

    public boolean hurt(ServerLevel p_376482_, EnderDragonPart p_31121_, DamageSource p_31122_, float p_31123_) {
        if (this.phaseManager.getCurrentPhase().getPhase() == EnderDragonPhase.DYING) {
            ...
            if (p_31123_ < 0.01F) {
                ...
                if (p_31122_.getEntity() instanceof Player || p_31122_.is(DamageTypeTags.ALWAYS_HURTS_ENDER_DRAGONS)) {
                    ...
                    this.reallyHurt(p_376482_, p_31122_, p_31123_);
    ...
    protected void reallyHurt(ServerLevel p_376842_, DamageSource p_31162_, float p_31163_) {
        super.hurtServer(p_376842_, p_31162_, p_31163_);
    }
    ...
    public int findClosestNode(double p_31171_, double p_31172_, double p_31173_) {
        float f = 10000.0F;
        int i = 0;
        Node node = new Node(Mth.bigFloor(p_31171_), Mth.floor(p_31172_), Mth.bigFloor(p_31173_));
        int j = 0;
    ...
    public void onCrystalDestroyed(ServerLevel p_376109_, EndCrystal p_31125_, BlockPos p_31126_, DamageSource p_31127_) {
        Player player;
        if (p_31127_.getEntity() instanceof Player) {
            player = (Player)p_31127_.getEntity();
        } else {
            player = p_376109_.getNearestPlayer(CRYSTAL_DESTROY_TARGETING, (double)p_31126_.getX(), (double)p_31126_.getY(), (double)p_31126_.getZ());
        }

        if (p_31125_ == this.nearestCrystal) {
            this.hurt(p_376109_, this.head, this.damageSources().explosion(p_31125_, player), 10.0F);
        }
