...
public class Dolphin extends AgeableWaterCreature {
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_28332_, DifficultyInstance p_28333_, EntitySpawnReason p_364784_, @Nullable SpawnGroupData p_28335_
    ) {
        this.setAirSupply(this.getMaxAirSupply());
        this.setXRot(0.0F);
        SpawnGroupData spawngroupdata = Objects.requireNonNullElseGet(p_28335_, () -> new AgeableMob.AgeableMobGroupData(0.1F));
        return super.finalizeSpawn(p_28332_, p_28333_, p_364784_, spawngroupdata);
    }

    @Nullable
    public Dolphin getBreedOffspring(ServerLevel p_361393_, AgeableMob p_362859_) {
        return EntityType.DOLPHIN.create(p_361393_, EntitySpawnReason.BREEDING);
    }
    ...
    @Override
    public boolean canAttack(LivingEntity p_363474_) {
        return !this.isBaby() && super.canAttack(p_363474_);
    }
    ...
    @Override
    protected boolean canDispenserEquipIntoSlot(EquipmentSlot p_371291_) {
        return p_371291_ == EquipmentSlot.MAINHAND && this.canPickUpLoot();
    }

    @Override
    protected void pickUpItem(ServerLevel p_376656_, ItemEntity p_28357_) {
