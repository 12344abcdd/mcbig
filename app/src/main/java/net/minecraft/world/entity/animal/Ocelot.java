...
public class Ocelot extends Animal {
    ...
    @Override
    public void customServerAiStep(ServerLevel p_376895_) {
    ...
    public static boolean checkOcelotSpawnRules(
        EntityType<Ocelot> p_218207_, LevelAccessor p_218208_, EntitySpawnReason p_364328_, BlockPos p_218210_, RandomSource p_218211_
    ) {
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_29007_, DifficultyInstance p_29008_, EntitySpawnReason p_362657_, @Nullable SpawnGroupData p_29010_
    ) {
        if (p_29010_ == null) {
            p_29010_ = new AgeableMob.AgeableMobGroupData(1.0F);
        }

        return super.finalizeSpawn(p_29007_, p_29008_, p_362657_, p_29010_);
    }
