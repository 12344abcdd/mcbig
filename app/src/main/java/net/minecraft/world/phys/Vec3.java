...
public class Vec3 implements Position {
    ...
    public Vec3(Vec3i p_365192_) {
        this((double)p_365192_.getX(), (double)p_365192_.getY(), (double)p_365192_.getZ());
    }

    public Vec3(me.alphamode.mcbig.core.Vec3l p_365192_) {
        this(p_365192_.getBigX().doubleValue(), p_365192_.getY(), p_365192_.getBigZ().doubleValue());
    }
    ...
    public Vec3 subtract(double p_361762_) {
        return this.subtract(p_361762_, p_361762_, p_361762_);
    }
    ...
    public Vec3 add(double p_361376_) {
        return this.add(p_361376_, p_361376_, p_361376_);
    }
    ...
    public double distanceToSqr(me.alphamode.mcbig.core.BigVec3 p_82558_) {
    ...
    public me.alphamode.mcbig.core.BigVec3 toBig() {
        return new me.alphamode.mcbig.core.BigVec3(this.x, this.y, this.z);
    }

    public Vec3 projectedOn(Vec3 p_374230_) {
        return p_374230_.lengthSqr() == 0.0 ? p_374230_ : p_374230_.scale(this.dot(p_374230_)).scale(1.0 / p_374230_.lengthSqr());
    }
}
