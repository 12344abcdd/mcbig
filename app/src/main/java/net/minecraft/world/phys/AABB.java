...
public class AABB {
    ...
    public static Optional<Vec3> clip(
        double p_361194_, double p_363689_, double p_360465_, double p_364788_, double p_361609_, double p_362064_, Vec3 p_360499_, Vec3 p_364132_
    ) {
        double[] adouble = new double[]{1.0};
        double d0 = p_364132_.x - p_360499_.x;
        double d1 = p_364132_.y - p_360499_.y;
        double d2 = p_364132_.z - p_360499_.z;
        Direction direction = getDirection(p_361194_, p_363689_, p_360465_, p_364788_, p_361609_, p_362064_, p_360499_, adouble, null, d0, d1, d2);
        if (direction == null) {
            return Optional.empty();
        } else {
            double d3 = adouble[0];
            return Optional.of(p_360499_.add(d3 * d0, d3 * d1, d3 * d2));
        }
    }
    ...
    public static BlockHitResult clip(Iterable<AABB> p_82343_, Vec3 p_82344_, Vec3 p_82345_, BlockPos p_82346_) {
        ...
        if (direction == null) {
            ...
            double d3 = adouble[0];
            return new BlockHitResult(new me.alphamode.mcbig.core.BigVec3(p_82344_).add(d3 * d0, d3 * d1, d3 * d2), direction, p_82346_, false);
        }
    }
    ...
    public boolean collidedAlongVector(Vec3 p_371478_, List<AABB> p_371359_) {
        Vec3 vec3 = this.getCenter();
        Vec3 vec31 = vec3.add(p_371478_);

        for (AABB aabb : p_371359_) {
