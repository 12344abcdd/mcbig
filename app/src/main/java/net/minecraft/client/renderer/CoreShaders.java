...
public class CoreShaders {
    ...
    public static final ShaderProgram RENDERTYPE_ENTITY_TRANSLUCENT_EMISSIVE = register(
        "rendertype_entity_translucent_emissive", DefaultVertexFormat.NEW_ENTITY
    );
    ...
    private static ShaderProgram register(String p_366671_, VertexFormat p_366614_) {
        return register(p_366671_, p_366614_, ShaderDefines.EMPTY);
    }

    private static ShaderProgram register(String p_366625_, VertexFormat p_366582_, ShaderDefines p_366657_) {
        ShaderProgram shaderprogram = new ShaderProgram(ResourceLocation.withDefaultNamespace("core/" + p_366625_), p_366582_, p_366657_);
