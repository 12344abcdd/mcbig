...
public class CompileTaskDynamicQueue {
    ...
    @Nullable
    public synchronized SectionRenderDispatcher.RenderSection.CompileTask poll(me.alphamode.mcbig.core.BigVec3 p_366737_) {
        int i = -1;
        int j = -1;
        ...
        while (listiterator.hasNext()) {
            ...
            if (sectionrenderdispatcher$rendersection$compiletask.isCancelled.get()) {
                ...
                double d2 = sectionrenderdispatcher$rendersection$compiletask.getOrigin().distToCenterSqr(p_366737_);
    ...
    private SectionRenderDispatcher.RenderSection.CompileTask removeTaskByIndex(int p_366525_) {
        return p_366525_ >= 0 ? this.tasks.remove(p_366525_) : null;
    }
