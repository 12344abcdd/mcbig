...
public class ModelBlockRenderer {
    ...
    static class AmbientOcclusionFace {
        ...
        public void calculate(
            BlockAndTintGetter p_111168_, BlockState p_111169_, BlockPos p_111170_, Direction p_366875_, float[] p_111172_, BitSet p_111173_, boolean p_366498_
        ) {
            BlockPos blockpos = p_111173_.get(0) ? p_111170_.relative(p_366875_) : p_111170_;
            ModelBlockRenderer.AdjacencyInfo modelblockrenderer$adjacencyinfo = ModelBlockRenderer.AdjacencyInfo.fromFacing(p_366875_);
            ...
            blockpos$mutableblockpos.setWithOffset(p_111170_, p_366875_);
            ...
            ModelBlockRenderer.AmbientVertexRemap modelblockrenderer$ambientvertexremap = ModelBlockRenderer.AmbientVertexRemap.fromFacing(p_366875_);
            ...
            float f30 = p_111168_.getShade(p_366875_, p_366498_);
