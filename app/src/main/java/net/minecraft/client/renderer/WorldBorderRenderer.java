...
public class WorldBorderRenderer {
    ...
    public void render(WorldBorder p_365515_, Vec3 p_360961_, double p_364707_, double p_361253_) {
        ...
        if (!(p_360961_.x < d1 - p_364707_) || !(p_360961_.x > d0 + p_364707_) || !(p_360961_.z < d3 - p_364707_) || !(p_360961_.z > d2 + p_364707_)) {
            ...
            double d7 = Math.max((double)Mth.floor(d6 - p_364707_), d2);
            double d8 = Math.min((double)Mth.ceil(d6 + p_364707_), d3);
            ...
            d7 = Math.max((double)Mth.floor(d5 - p_364707_), d0);
            d8 = Math.min((double)Mth.ceil(d5 + p_364707_), d1);
