...
public class SoundEngine {
    ...
    public void setVolume(SoundInstance p_382891_, float p_382956_) {
        if (this.loaded) {
            ChannelAccess.ChannelHandle channelaccess$channelhandle = this.instanceToChannel.get(p_382891_);
            if (channelaccess$channelhandle != null) {
                channelaccess$channelhandle.execute(p_382558_ -> p_382558_.setVolume(p_382956_ * this.calculateVolume(p_382891_)));
            }
        }
    }
    ...
    public void updateSource(Camera p_120271_) {
        if (this.loaded && p_120271_.isInitialized()) {
            ListenerTransform listenertransform = new ListenerTransform(
                p_120271_.getPosition().toVanilla(), new Vec3(p_120271_.getLookVector()), new Vec3(p_120271_.getUpVector())
            );
