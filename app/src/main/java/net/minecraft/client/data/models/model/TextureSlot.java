...
public final class TextureSlot {
    ...
    private static TextureSlot create(String p_388394_) {
        return new TextureSlot(p_388394_, null);
    }

    private static TextureSlot create(String p_387134_, TextureSlot p_386625_) {
        return new TextureSlot(p_387134_, p_386625_);
    }

    private TextureSlot(String p_387501_, @Nullable TextureSlot p_387555_) {
        this.id = p_387501_;
        this.parent = p_387555_;
    }
