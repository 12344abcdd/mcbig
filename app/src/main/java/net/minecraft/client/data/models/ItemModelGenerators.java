...
public class ItemModelGenerators {
    ...
    private ResourceLocation createFlatItemModel(Item p_387136_, Item p_386454_, ModelTemplate p_388608_) {
        return p_388608_.create(ModelLocationUtils.getModelLocation(p_387136_), TextureMapping.layer0(p_386454_), this.modelOutput);
    }

    private void generateFlatItem(Item p_388277_, Item p_388078_, ModelTemplate p_387994_) {
        this.itemModelOutput.accept(p_388277_, ItemModelUtils.plainModel(this.createFlatItemModel(p_388277_, p_388078_, p_387994_)));
    }

    private void generateItemWithTintedOverlay(Item p_386979_, ItemTintSource p_388847_) {
        this.generateItemWithTintedOverlay(p_386979_, "_overlay", p_388847_);
    }

    private void generateItemWithTintedOverlay(Item p_388114_, String p_387438_, ItemTintSource p_387225_) {
    ...
    private List<RangeSelectItemModel.Entry> createCompassModels(Item p_386730_) {
    ...
    private void generateStandardCompassItem(Item p_388204_) {
    ...
    private void generateRecoveryCompassItem(Item p_386605_) {
        this.itemModelOutput
            .accept(
                p_386605_,
    ...
    private void generateClockItem(Item p_387705_) {
        List<RangeSelectItemModel.Entry> list = new ArrayList<>();
    ...
    private ResourceLocation generateLayeredItem(Item p_388230_, ResourceLocation p_388087_, ResourceLocation p_386610_) {
        return ModelTemplates.TWO_LAYERED_ITEM.create(p_388230_, TextureMapping.layered(p_388087_, p_386610_), this.modelOutput);
    }

    private ResourceLocation generateLayeredItem(ResourceLocation p_386992_, ResourceLocation p_386528_, ResourceLocation p_386966_) {
        return ModelTemplates.TWO_LAYERED_ITEM.create(p_386992_, TextureMapping.layered(p_386528_, p_386966_), this.modelOutput);
    }

    private void generateLayeredItem(ResourceLocation p_386617_, ResourceLocation p_388707_, ResourceLocation p_387768_, ResourceLocation p_388354_) {
        ModelTemplates.THREE_LAYERED_ITEM.create(p_386617_, TextureMapping.layered(p_388707_, p_387768_, p_388354_), this.modelOutput);
    }

    private void generateTrimmableItem(Item p_386877_, ResourceKey<EquipmentAsset> p_388083_, String p_387979_, boolean p_387785_) {
    ...
    private void generateBundleModels(Item p_388570_) {
    ...
    private ResourceLocation generateBundleCoverModel(Item p_387153_, ModelTemplate p_388214_, String p_387206_) {
    ...
    private void generateBow(Item p_387215_) {
    ...
    private void generateCrossbow(Item p_387491_) {
    ...
    private void generateBooleanDispatch(Item p_387110_, ConditionalItemModelProperty p_388865_, ItemModel.Unbaked p_387060_, ItemModel.Unbaked p_388146_) {
        this.itemModelOutput.accept(p_387110_, ItemModelUtils.conditional(p_388865_, p_387060_, p_388146_));
    }

    private void generateElytra(Item p_387928_) {
    ...
    private void generateBrush(Item p_387911_) {
    ...
    private void generateFishingRod(Item p_387412_) {
    ...
    private void generateGoatHorn(Item p_387137_) {
    ...
    private void generateShield(Item p_386530_) {
    ...
    private static ItemModel.Unbaked createFlatModelDispatch(ItemModel.Unbaked p_388864_, ItemModel.Unbaked p_388747_) {
    ...
    private void generateSpyglass(Item p_387067_) {
    ...
    private void generateTrident(Item p_387274_) {
    ...
    private void addPotionTint(Item p_388495_, ResourceLocation p_386558_) {
        this.itemModelOutput.accept(p_388495_, ItemModelUtils.tintedModel(p_386558_, new Potion()));
    }

    private void generatePotion(Item p_387941_) {
        ResourceLocation resourcelocation = this.generateLayeredItem(
    ...
    private void generateTippedArrow(Item p_387880_) {
        ResourceLocation resourcelocation = this.generateLayeredItem(
    ...
    private void generateDyedItem(Item p_388875_, int p_388379_) {
    ...
    private void generateSpawnEgg(Item p_387114_, int p_387737_, int p_387138_) {
    ...
    private void generateWolfArmor(Item p_388321_) {
