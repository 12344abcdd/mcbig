...
public class Main {
    ...
    public static void main(String[] p_129642_) {
        ...
        try {
            ...
            User user = new User(
                optionspec14.value(optionset), uuid, optionspec18.value(optionset), emptyStringToEmptyOptional(s8), emptyStringToEmptyOptional(s9), user$type
            );
    ...
    private static boolean hasValidUuid(OptionSpec<String> p_363205_, OptionSet p_360329_, Logger p_360443_) {
        return p_360329_.has(p_363205_) && isUuidValid(p_363205_, p_360329_, p_360443_);
    }

    private static boolean isUuidValid(OptionSpec<String> p_363850_, OptionSet p_365053_, Logger p_362169_) {
        try {
            UndashedUuid.fromStringLenient(p_363850_.value(p_365053_));
            return true;
        } catch (IllegalArgumentException illegalargumentexception) {
            p_362169_.warn("Invalid UUID: '{}", p_363850_.value(p_365053_));
            return false;
        }
    }
