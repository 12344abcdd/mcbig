...
public class SnifferModel extends EntityModel<SnifferRenderState> {
    ...
    public void setupAnim(SnifferRenderState p_363751_) {
        super.setupAnim(p_363751_);
        this.head.xRot = p_363751_.xRot * (float) (Math.PI / 180.0);
        this.head.yRot = p_363751_.yRot * (float) (Math.PI / 180.0);
