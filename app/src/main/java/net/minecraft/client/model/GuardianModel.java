...
public class GuardianModel extends EntityModel<GuardianRenderState> {
    ...
    public void setupAnim(GuardianRenderState p_363160_) {
        super.setupAnim(p_363160_);
        this.head.yRot = p_363160_.yRot * (float) (Math.PI / 180.0);
        this.head.xRot = p_363160_.xRot * (float) (Math.PI / 180.0);
        float f = (1.0F - p_363160_.spikesAnimation) * 0.55F;
        this.setupSpikes(p_363160_.ageInTicks, f);
        if (p_363160_.lookAtPosition != null && p_363160_.lookDirection != null) {
            double d0 = p_363160_.lookAtPosition.y - p_363160_.eyePosition.y;
            if (d0 > 0.0) {
                this.eye.y = 0.0F;
            } else {
                this.eye.y = 1.0F;
            ...
            Vec3 vec3 = p_363160_.lookDirection;
            vec3 = new Vec3(vec3.x, 0.0, vec3.z);
            Vec3 vec31 = new Vec3(p_363160_.eyePosition.x - p_363160_.lookAtPosition.x, 0.0, p_363160_.eyePosition.z - p_363160_.lookAtPosition.z)
                .normalize()
        ...
        float f1 = p_363160_.tailAnimation;
