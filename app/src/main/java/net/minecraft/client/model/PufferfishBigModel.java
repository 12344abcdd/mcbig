...
public class PufferfishBigModel extends EntityModel<EntityRenderState> {
    ...
    @Override
    public void setupAnim(EntityRenderState p_363774_) {
        super.setupAnim(p_363774_);
        this.rightBlueFin.zRot = -0.2F + 0.4F * Mth.sin(p_363774_.ageInTicks * 0.2F);
        this.leftBlueFin.zRot = 0.2F - 0.4F * Mth.sin(p_363774_.ageInTicks * 0.2F);
    }
}
