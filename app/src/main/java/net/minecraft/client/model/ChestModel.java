...
public class ChestModel extends Model {
    ...
    public ChestModel(ModelPart p_365020_) {
        super(p_365020_, RenderType::entitySolid);
        this.lid = p_365020_.getChild("lid");
        this.lock = p_365020_.getChild("lock");
    }
    ...
    public void setupAnim(float p_363974_) {
        this.lid.xRot = -(p_363974_ * (float) (Math.PI / 2));
