...
public class SkeletonModel<S extends SkeletonRenderState> extends HumanoidModel<S> {
    ...
    public void setupAnim(S p_361079_) {
        super.setupAnim(p_361079_);
        if (p_361079_.isAggressive && !p_361079_.isHoldingBow) {
            float f = p_361079_.attackTime;
            ...
            AnimationUtils.bobArms(this.rightArm, this.leftArm, p_361079_.ageInTicks);
        }
    }
