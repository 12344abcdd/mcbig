...
public class ElytraModel extends EntityModel<HumanoidRenderState> {
    ...
    public void setupAnim(HumanoidRenderState p_361220_) {
        super.setupAnim(p_361220_);
        this.leftWing.y = p_361220_.isCrouching ? 3.0F : 0.0F;
        this.leftWing.xRot = p_361220_.elytraRotX;
        this.leftWing.zRot = p_361220_.elytraRotZ;
        this.leftWing.yRot = p_361220_.elytraRotY;
