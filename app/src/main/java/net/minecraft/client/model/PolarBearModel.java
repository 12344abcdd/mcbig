...
public class PolarBearModel extends QuadrupedModel<PolarBearRenderState> {
    ...
    public void setupAnim(PolarBearRenderState p_364803_) {
        super.setupAnim(p_364803_);
        float f = p_364803_.standScale * p_364803_.standScale;
        float f1 = p_364803_.ageScale;
        float f2 = p_364803_.isBaby ? 0.44444445F : 1.0F;
