...
public class SnowGolemModel extends EntityModel<LivingEntityRenderState> {
    ...
    public void setupAnim(LivingEntityRenderState p_363168_) {
        super.setupAnim(p_363168_);
        this.head.yRot = p_363168_.yRot * (float) (Math.PI / 180.0);
        this.head.xRot = p_363168_.xRot * (float) (Math.PI / 180.0);
        this.upperBody.yRot = p_363168_.yRot * (float) (Math.PI / 180.0) * 0.25F;
