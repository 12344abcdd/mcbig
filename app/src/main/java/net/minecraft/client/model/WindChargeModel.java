...
public class WindChargeModel extends EntityModel<EntityRenderState> {
    ...
    public WindChargeModel(ModelPart p_312471_) {
        super(p_312471_, RenderType::entityTranslucent);
    ...
    @Override
    public void setupAnim(EntityRenderState p_362619_) {
        super.setupAnim(p_362619_);
        this.windCharge.yRot = -p_362619_.ageInTicks * 16.0F * (float) (Math.PI / 180.0);
        this.wind.yRot = p_362619_.ageInTicks * 16.0F * (float) (Math.PI / 180.0);
    }
}
