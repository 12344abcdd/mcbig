...
public class BreezeModel extends EntityModel<BreezeRenderState> {
    ...
    public BreezeModel(ModelPart p_312152_) {
        super(p_312152_, RenderType::entityTranslucent);
    ...
    public void setupAnim(BreezeRenderState p_360635_) {
        super.setupAnim(p_360635_);
        this.animate(p_360635_.idle, BreezeAnimation.IDLE, p_360635_.ageInTicks);
        this.animate(p_360635_.shoot, BreezeAnimation.SHOOT, p_360635_.ageInTicks);
        this.animate(p_360635_.slide, BreezeAnimation.SLIDE, p_360635_.ageInTicks);
        this.animate(p_360635_.slideBack, BreezeAnimation.SLIDE_BACK, p_360635_.ageInTicks);
        this.animate(p_360635_.inhale, BreezeAnimation.INHALE, p_360635_.ageInTicks);
        this.animate(p_360635_.longJump, BreezeAnimation.JUMP, p_360635_.ageInTicks);
    }
