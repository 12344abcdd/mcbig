...
public class ArmorStandModel extends ArmorStandArmorModel {
    ...
    @Override
    public void setupAnim(ArmorStandRenderState p_360688_) {
        super.setupAnim(p_360688_);
        this.basePlate.yRot = (float) (Math.PI / 180.0) * -p_360688_.yRot;
        this.leftArm.visible = p_360688_.showArms;
        this.rightArm.visible = p_360688_.showArms;
        this.basePlate.visible = p_360688_.showBasePlate;
        this.rightBodyStick.xRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.getX();
        this.rightBodyStick.yRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.getY();
        this.rightBodyStick.zRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.getZ();
        this.leftBodyStick.xRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.getX();
        this.leftBodyStick.yRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.getY();
        this.leftBodyStick.zRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.getZ();
        this.shoulderStick.xRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.getX();
        this.shoulderStick.yRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.getY();
        this.shoulderStick.zRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.getZ();
    }
