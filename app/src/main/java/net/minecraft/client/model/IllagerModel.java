...
public class IllagerModel<S extends IllagerRenderState> extends EntityModel<S> implements ArmedModel, HeadedModel {
    ...
    public void setupAnim(S p_363122_) {
        super.setupAnim(p_363122_);
        this.head.yRot = p_363122_.yRot * (float) (Math.PI / 180.0);
        this.head.xRot = p_363122_.xRot * (float) (Math.PI / 180.0);
        if (p_363122_.isRiding) {
            ...
            float f = p_363122_.walkAnimationSpeed;
            float f1 = p_363122_.walkAnimationPos;
        ...
        AbstractIllager.IllagerArmPose abstractillager$illagerarmpose = p_363122_.armPose;
        if (abstractillager$illagerarmpose == AbstractIllager.IllagerArmPose.ATTACKING) {
            if (p_363122_.getMainHandItem().isEmpty()) {
                AnimationUtils.animateZombieArms(this.leftArm, this.rightArm, true, p_363122_.attackAnim, p_363122_.ageInTicks);
            } else {
                AnimationUtils.swingWeaponDown(this.rightArm, this.leftArm, p_363122_.mainArm, p_363122_.attackAnim, p_363122_.ageInTicks);
            }
            ...
            this.leftArm.z = 0.0F;
            this.leftArm.x = 5.0F;
            this.rightArm.xRot = Mth.cos(p_363122_.ageInTicks * 0.6662F) * 0.25F;
            this.leftArm.xRot = Mth.cos(p_363122_.ageInTicks * 0.6662F) * 0.25F;
            ...
            AnimationUtils.animateCrossbowCharge(this.rightArm, this.leftArm, (float)p_363122_.maxCrossbowChargeDuration, p_363122_.ticksUsingItem, true);
        } else if (abstractillager$illagerarmpose == AbstractIllager.IllagerArmPose.CELEBRATING) {
            this.rightArm.z = 0.0F;
            this.rightArm.x = -5.0F;
            this.rightArm.xRot = Mth.cos(p_363122_.ageInTicks * 0.6662F) * 0.05F;
            this.rightArm.zRot = 2.670354F;
            this.rightArm.yRot = 0.0F;
            this.leftArm.z = 0.0F;
            this.leftArm.x = 5.0F;
            this.leftArm.xRot = Mth.cos(p_363122_.ageInTicks * 0.6662F) * 0.05F;
            this.leftArm.zRot = (float) (-Math.PI * 3.0 / 4.0);
            this.leftArm.yRot = 0.0F;
        }
