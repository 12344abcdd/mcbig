...
public class PufferfishSmallModel extends EntityModel<EntityRenderState> {
    ...
    @Override
    public void setupAnim(EntityRenderState p_361385_) {
        super.setupAnim(p_361385_);
        this.rightFin.zRot = -0.2F + 0.4F * Mth.sin(p_361385_.ageInTicks * 0.2F);
        this.leftFin.zRot = 0.2F - 0.4F * Mth.sin(p_361385_.ageInTicks * 0.2F);
    }
}
