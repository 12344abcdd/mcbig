...
public class SalmonModel extends EntityModel<SalmonRenderState> {
    ...
    public void setupAnim(SalmonRenderState p_361445_) {
        super.setupAnim(p_361445_);
        float f = 1.0F;
        float f1 = 1.0F;
        if (!p_361445_.isInWater) {
            f = 1.3F;
            f1 = 1.7F;
        }

        this.bodyBack.yRot = -f * 0.25F * Mth.sin(f1 * 0.6F * p_361445_.ageInTicks);
    }
}
