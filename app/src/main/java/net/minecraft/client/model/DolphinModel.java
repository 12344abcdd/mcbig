...
public class DolphinModel extends EntityModel<DolphinRenderState> {
    ...
    public void setupAnim(DolphinRenderState p_361177_) {
        super.setupAnim(p_361177_);
        this.body.xRot = p_361177_.xRot * (float) (Math.PI / 180.0);
        this.body.yRot = p_361177_.yRot * (float) (Math.PI / 180.0);
        if (p_361177_.isMoving) {
            this.body.xRot = this.body.xRot + (-0.05F - 0.05F * Mth.cos(p_361177_.ageInTicks * 0.3F));
            this.tail.xRot = -0.1F * Mth.cos(p_361177_.ageInTicks * 0.3F);
            this.tailFin.xRot = -0.2F * Mth.cos(p_361177_.ageInTicks * 0.3F);
        }
    }
}
