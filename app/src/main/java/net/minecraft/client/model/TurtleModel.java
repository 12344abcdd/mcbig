...
public class TurtleModel extends QuadrupedModel<TurtleRenderState> {
    ...
    public void setupAnim(TurtleRenderState p_362846_) {
        super.setupAnim(p_362846_);
        float f = p_362846_.walkAnimationPos;
        float f1 = p_362846_.walkAnimationSpeed;
        if (p_362846_.isOnLand) {
            float f2 = p_362846_.isLayingEgg ? 4.0F : 1.0F;
            float f3 = p_362846_.isLayingEgg ? 2.0F : 1.0F;
            float f4 = f * 5.0F;
        ...
        this.eggBelly.visible = p_362846_.hasEgg;
