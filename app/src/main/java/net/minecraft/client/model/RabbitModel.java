...
public class RabbitModel extends EntityModel<RabbitRenderState> {
    ...
    public static LayerDefinition createBodyLayer(boolean p_364708_) {
        ...
        return LayerDefinition.create(meshdefinition, 64, 32).apply(p_364708_ ? BABY_TRANSFORMER : ADULT_TRANSFORMER);
    }

    public void setupAnim(RabbitRenderState p_360680_) {
        super.setupAnim(p_360680_);
        this.head.xRot = p_360680_.xRot * (float) (Math.PI / 180.0);
        this.head.yRot = p_360680_.yRot * (float) (Math.PI / 180.0);
        float f = Mth.sin(p_360680_.jumpCompletion * (float) Math.PI);
