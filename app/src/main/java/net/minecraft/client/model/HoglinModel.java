...
public class HoglinModel extends EntityModel<HoglinRenderState> {
    ...
    public void setupAnim(HoglinRenderState p_364969_) {
        super.setupAnim(p_364969_);
        ...
        this.head.yRot = p_364969_.yRot * (float) (Math.PI / 180.0);
        float f2 = 1.0F - (float)Mth.abs(10 - 2 * p_364969_.attackAnimationRemainingTicks) / 10.0F;
