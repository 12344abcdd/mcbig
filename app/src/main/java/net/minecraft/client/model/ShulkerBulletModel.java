...
public class ShulkerBulletModel extends EntityModel<ShulkerBulletRenderState> {
    ...
    public void setupAnim(ShulkerBulletRenderState p_361489_) {
        super.setupAnim(p_361489_);
        this.main.yRot = p_361489_.yRot * (float) (Math.PI / 180.0);
        this.main.xRot = p_361489_.xRot * (float) (Math.PI / 180.0);
    }
}
