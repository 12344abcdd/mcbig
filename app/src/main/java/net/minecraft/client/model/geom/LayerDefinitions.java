...
public class LayerDefinitions {
    ...
    public static Map<ModelLayerLocation, LayerDefinition> createRoots() {
        ...
        WoodType.values().forEach(p_382521_ -> {
            builder.put(ModelLayers.createStandingSignModelName(p_382521_), layerdefinition53);
            builder.put(ModelLayers.createWallSignModelName(p_382521_), layerdefinition54);
