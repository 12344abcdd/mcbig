...
public class GoatModel extends QuadrupedModel<GoatRenderState> {
    ...
    public void setupAnim(GoatRenderState p_360890_) {
        super.setupAnim(p_360890_);
        this.head.getChild("left_horn").visible = p_360890_.hasLeftHorn;
        this.head.getChild("right_horn").visible = p_360890_.hasRightHorn;
        if (p_360890_.rammingXHeadRot != 0.0F) {
            this.head.xRot = p_360890_.rammingXHeadRot;
        }
    }
}
