...
public class BatModel extends EntityModel<BatRenderState> {
    ...
    public void setupAnim(BatRenderState p_365165_) {
        super.setupAnim(p_365165_);
        if (p_365165_.isResting) {
            this.applyHeadRotation(p_365165_.yRot);
        }

        this.animate(p_365165_.flyAnimationState, BatAnimation.BAT_FLYING, p_365165_.ageInTicks, 1.0F);
        this.animate(p_365165_.restAnimationState, BatAnimation.BAT_RESTING, p_365165_.ageInTicks, 1.0F);
    }
