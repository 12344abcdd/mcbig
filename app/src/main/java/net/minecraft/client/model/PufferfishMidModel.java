...
public class PufferfishMidModel extends EntityModel<EntityRenderState> {
    ...
    @Override
    public void setupAnim(EntityRenderState p_363952_) {
        super.setupAnim(p_363952_);
        this.rightBlueFin.zRot = -0.2F + 0.4F * Mth.sin(p_363952_.ageInTicks * 0.2F);
        this.leftBlueFin.zRot = 0.2F - 0.4F * Mth.sin(p_363952_.ageInTicks * 0.2F);
    }
}
