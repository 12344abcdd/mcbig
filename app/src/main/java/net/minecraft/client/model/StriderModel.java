...
public class StriderModel extends EntityModel<StriderRenderState> {
    ...
    public void setupAnim(StriderRenderState p_363860_) {
        super.setupAnim(p_363860_);
        float f = p_363860_.walkAnimationPos;
        float f1 = Math.min(p_363860_.walkAnimationSpeed, 0.25F);
        if (!p_363860_.isRidden) {
            this.body.xRot = p_363860_.xRot * (float) (Math.PI / 180.0);
            this.body.yRot = p_363860_.yRot * (float) (Math.PI / 180.0);
        } else {
            this.body.xRot = 0.0F;
            this.body.yRot = 0.0F;
        }
        ...
        float f4 = 1.0F;
        float f5 = 1.0F;
        this.rightBottomBristle.zRot = this.rightBottomBristle.zRot + 0.05F * Mth.sin(p_363860_.ageInTicks * 1.0F * -0.4F);
        this.rightMiddleBristle.zRot = this.rightMiddleBristle.zRot + 0.1F * Mth.sin(p_363860_.ageInTicks * 1.0F * 0.2F);
        this.rightTopBristle.zRot = this.rightTopBristle.zRot + 0.1F * Mth.sin(p_363860_.ageInTicks * 1.0F * 0.4F);
        this.leftTopBristle.zRot = this.leftTopBristle.zRot + 0.1F * Mth.sin(p_363860_.ageInTicks * 1.0F * 0.4F);
        this.leftMiddleBristle.zRot = this.leftMiddleBristle.zRot + 0.1F * Mth.sin(p_363860_.ageInTicks * 1.0F * 0.2F);
        this.leftBottomBristle.zRot = this.leftBottomBristle.zRot + 0.05F * Mth.sin(p_363860_.ageInTicks * 1.0F * -0.4F);
    }
}
