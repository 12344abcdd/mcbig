...
public class WardenModel extends EntityModel<WardenRenderState> {
    ...
    public void setupAnim(WardenRenderState p_362289_) {
        ...
        this.animate(p_362289_.attackAnimationState, WardenAnimation.WARDEN_ATTACK, p_362289_.ageInTicks);
        this.animate(p_362289_.sonicBoomAnimationState, WardenAnimation.WARDEN_SONIC_BOOM, p_362289_.ageInTicks);
        this.animate(p_362289_.diggingAnimationState, WardenAnimation.WARDEN_DIG, p_362289_.ageInTicks);
        this.animate(p_362289_.emergeAnimationState, WardenAnimation.WARDEN_EMERGE, p_362289_.ageInTicks);
        this.animate(p_362289_.roarAnimationState, WardenAnimation.WARDEN_ROAR, p_362289_.ageInTicks);
        this.animate(p_362289_.sniffAnimationState, WardenAnimation.WARDEN_SNIFF, p_362289_.ageInTicks);
    }
    ...
    private void animateTendrils(WardenRenderState p_360923_, float p_233528_) {
        float f = p_360923_.tendrilAnimation * (float)(Math.cos((double)p_233528_ * 2.25) * Math.PI * 0.1F);
