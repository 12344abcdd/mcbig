...
public class WitherBossModel extends EntityModel<WitherRenderState> {
    ...
    public void setupAnim(WitherRenderState p_365401_) {
        ...
        setupHeadRotation(p_365401_, this.rightHead, 0);
        setupHeadRotation(p_365401_, this.leftHead, 1);
        ...
        this.centerHead.yRot = p_365401_.yRot * (float) (Math.PI / 180.0);
        this.centerHead.xRot = p_365401_.xRot * (float) (Math.PI / 180.0);
    }

    private static void setupHeadRotation(WitherRenderState p_360725_, ModelPart p_171073_, int p_171074_) {
        p_171073_.yRot = (p_360725_.yHeadRots[p_171074_] - p_360725_.bodyRot) * (float) (Math.PI / 180.0);
        p_171073_.xRot = p_360725_.xHeadRots[p_171074_] * (float) (Math.PI / 180.0);
    }
}
