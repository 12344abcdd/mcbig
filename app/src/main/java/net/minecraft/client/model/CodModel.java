...
public class CodModel extends EntityModel<LivingEntityRenderState> {
    ...
    public void setupAnim(LivingEntityRenderState p_364833_) {
        super.setupAnim(p_364833_);
        float f = p_364833_.isInWater ? 1.0F : 1.5F;
        this.tailFin.yRot = -f * 0.45F * Mth.sin(0.6F * p_364833_.ageInTicks);
    }
}
