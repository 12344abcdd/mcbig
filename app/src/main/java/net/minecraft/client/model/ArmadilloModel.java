...
public class ArmadilloModel extends EntityModel<ArmadilloRenderState> {
    ...
    public void setupAnim(ArmadilloRenderState p_360704_) {
        ...
        this.animateWalk(ArmadilloAnimation.ARMADILLO_WALK, p_360704_.walkAnimationPos, p_360704_.walkAnimationSpeed, 16.5F, 2.5F);
        this.animate(p_360704_.rollOutAnimationState, ArmadilloAnimation.ARMADILLO_ROLL_OUT, p_360704_.ageInTicks, 1.0F);
        this.animate(p_360704_.rollUpAnimationState, ArmadilloAnimation.ARMADILLO_ROLL_UP, p_360704_.ageInTicks, 1.0F);
        this.animate(p_360704_.peekAnimationState, ArmadilloAnimation.ARMADILLO_PEEK, p_360704_.ageInTicks, 1.0F);
    }
}
