...
public abstract class AbstractEquineModel<T extends EquineRenderState> extends EntityModel<T> {
    ...
    public static MeshDefinition createBodyMesh(CubeDeformation p_362889_) {
        ...
        PartDefinition partdefinition3 = partdefinition2.addOrReplaceChild(
            "head", CubeListBuilder.create().texOffs(0, 13).addBox(-3.0F, -11.0F, -2.0F, 6.0F, 5.0F, 7.0F, p_362889_), PartPose.ZERO
        );
        partdefinition2.addOrReplaceChild(
            "mane", CubeListBuilder.create().texOffs(56, 36).addBox(-1.0F, -11.0F, 5.01F, 2.0F, 16.0F, 2.0F, p_362889_), PartPose.ZERO
        );
        partdefinition2.addOrReplaceChild(
            "upper_mouth", CubeListBuilder.create().texOffs(0, 25).addBox(-2.0F, -11.0F, -7.0F, 4.0F, 5.0F, 5.0F, p_362889_), PartPose.ZERO
        );
        partdefinition.addOrReplaceChild(
            "left_hind_leg",
            CubeListBuilder.create().texOffs(48, 21).mirror().addBox(-3.0F, -1.01F, -1.0F, 4.0F, 11.0F, 4.0F, p_362889_),
            PartPose.offset(4.0F, 14.0F, 7.0F)
        );
        partdefinition.addOrReplaceChild(
            "right_hind_leg",
            CubeListBuilder.create().texOffs(48, 21).addBox(-1.0F, -1.01F, -1.0F, 4.0F, 11.0F, 4.0F, p_362889_),
            PartPose.offset(-4.0F, 14.0F, 7.0F)
        );
        partdefinition.addOrReplaceChild(
            "left_front_leg",
            CubeListBuilder.create().texOffs(48, 21).mirror().addBox(-3.0F, -1.01F, -1.9F, 4.0F, 11.0F, 4.0F, p_362889_),
            PartPose.offset(4.0F, 14.0F, -10.0F)
        );
        partdefinition.addOrReplaceChild(
            "right_front_leg",
            CubeListBuilder.create().texOffs(48, 21).addBox(-1.0F, -1.01F, -1.9F, 4.0F, 11.0F, 4.0F, p_362889_),
            PartPose.offset(-4.0F, 14.0F, -10.0F)
        );
        partdefinition1.addOrReplaceChild(
            "tail",
            CubeListBuilder.create().texOffs(42, 36).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 14.0F, 4.0F, p_362889_),
        ...
        partdefinition2.addOrReplaceChild(
            "left_saddle_mouth", CubeListBuilder.create().texOffs(29, 5).addBox(2.0F, -9.0F, -6.0F, 1.0F, 2.0F, 2.0F, p_362889_), PartPose.ZERO
        );
        partdefinition2.addOrReplaceChild(
            "right_saddle_mouth", CubeListBuilder.create().texOffs(29, 5).addBox(-3.0F, -9.0F, -6.0F, 1.0F, 2.0F, 2.0F, p_362889_), PartPose.ZERO
        );
        partdefinition2.addOrReplaceChild(
            "left_saddle_line",
    ...
    public static MeshDefinition createBabyMesh(CubeDeformation p_361910_) {
        return BABY_TRANSFORMER.apply(createFullScaleBabyMesh(p_361910_));
    }

    protected static MeshDefinition createFullScaleBabyMesh(CubeDeformation p_360459_) {
        MeshDefinition meshdefinition = createBodyMesh(p_360459_);
        PartDefinition partdefinition = meshdefinition.getRoot();
    ...
    public void setupAnim(T p_363341_) {
        ...
        for (ModelPart modelpart : this.saddleParts) {
            modelpart.visible = p_363341_.isSaddled;
        }

        for (ModelPart modelpart1 : this.ridingParts) {
            modelpart1.visible = p_363341_.isRidden && p_363341_.isSaddled;
        }

        float f13 = Mth.clamp(p_363341_.yRot, -20.0F, 20.0F);
        float f14 = p_363341_.xRot * (float) (Math.PI / 180.0);
        float f15 = p_363341_.walkAnimationSpeed;
        float f16 = p_363341_.walkAnimationPos;
        if (f15 > 0.2F) {
            f14 += Mth.cos(f16 * 0.8F) * 0.15F * f15;
        }

        float f = p_363341_.eatAnimation;
        float f1 = p_363341_.standAnimation;
        float f2 = 1.0F - f1;
        float f3 = p_363341_.feedingAnimation;
        boolean flag = p_363341_.animateTail;
        this.headParts.xRot = (float) (Math.PI / 6) + f14;
        this.headParts.yRot = f13 * (float) (Math.PI / 180.0);
        float f4 = p_363341_.isInWater ? 0.2F : 1.0F;
        float f5 = Mth.cos(f4 * f16 * 0.6662F + (float) Math.PI);
        float f6 = f5 * 0.8F * f15;
        float f7 = (1.0F - Math.max(f1, f)) * ((float) (Math.PI / 6) + f14 + f3 * Mth.sin(p_363341_.ageInTicks) * 0.05F);
        this.headParts.xRot = f1 * ((float) (Math.PI / 12) + f14) + f * (2.1816616F + Mth.sin(p_363341_.ageInTicks) * 0.05F) + f7;
        this.headParts.yRot = f1 * f13 * (float) (Math.PI / 180.0) + (1.0F - Math.max(f1, f)) * this.headParts.yRot;
        float f8 = p_363341_.ageScale;
        ...
        float f10 = Mth.cos(p_363341_.ageInTicks * 0.6F + (float) Math.PI);
        ...
        if (flag) {
            this.tail.yRot = Mth.cos(p_363341_.ageInTicks * 0.7F);
        } else {
            this.tail.yRot = 0.0F;
        }
    }
