...
public class FelineModel<T extends FelineRenderState> extends EntityModel<T> {
    ...
    public FelineModel(ModelPart p_363438_) {
        ...
        this.tail1 = p_363438_.getChild("tail1");
        this.tail2 = p_363438_.getChild("tail2");
    ...
    public static MeshDefinition createBodyMesh(CubeDeformation p_360911_) {
        ...
        partdefinition.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .addBox("main", -2.5F, -2.0F, -3.0F, 5.0F, 4.0F, 5.0F, p_360911_)
                .addBox("nose", -1.5F, -0.001F, -4.0F, 3, 2, 2, p_360911_, 0, 24)
                .addBox("ear1", -2.0F, -3.0F, 0.0F, 1, 1, 2, p_360911_, 0, 10)
                .addBox("ear2", 1.0F, -3.0F, 0.0F, 1, 1, 2, p_360911_, 6, 10),
            PartPose.offset(0.0F, 15.0F, -9.0F)
        );
        partdefinition.addOrReplaceChild(
            "body",
            CubeListBuilder.create().texOffs(20, 0).addBox(-2.0F, 3.0F, -8.0F, 4.0F, 16.0F, 6.0F, p_360911_),
            PartPose.offsetAndRotation(0.0F, 12.0F, -10.0F, (float) (Math.PI / 2), 0.0F, 0.0F)
        );
        partdefinition.addOrReplaceChild(
            "tail1",
            CubeListBuilder.create().texOffs(0, 15).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 8.0F, 1.0F, p_360911_),
    ...
    public void setupAnim(T p_365420_) {
        ...
        float f = p_365420_.ageScale;
        if (p_365420_.isCrouching) {
            this.body.y += 1.0F * f;
            this.head.y += 2.0F * f;
            this.tail1.y += 1.0F * f;
            this.tail2.y += -4.0F * f;
        ...
        this.head.xRot = p_365420_.xRot * (float) (Math.PI / 180.0);
        this.head.yRot = p_365420_.yRot * (float) (Math.PI / 180.0);
        if (!p_365420_.isSitting) {
            this.body.xRot = (float) (Math.PI / 2);
            float f1 = p_365420_.walkAnimationSpeed;
            float f2 = p_365420_.walkAnimationPos;
            if (p_365420_.isSprinting) {
        ...
        if (p_365420_.lieDownAmount > 0.0F) {
            this.head.zRot = Mth.rotLerp(p_365420_.lieDownAmount, this.head.zRot, -1.2707963F);
            this.head.yRot = Mth.rotLerp(p_365420_.lieDownAmount, this.head.yRot, 1.2707963F);
            ...
            this.tail1.xRot = Mth.rotLerp(p_365420_.lieDownAmountTail, this.tail1.xRot, 0.8F);
            this.tail2.xRot = Mth.rotLerp(p_365420_.lieDownAmountTail, this.tail2.xRot, -0.4F);
        }

        if (p_365420_.relaxStateOneAmount > 0.0F) {
            this.head.xRot = Mth.rotLerp(p_365420_.relaxStateOneAmount, this.head.xRot, -0.58177644F);
        }
    }
}
