...
public abstract class AbstractContainerWidget extends AbstractScrollArea implements ContainerEventHandler {
    ...
    public boolean mouseClicked(double p_313764_, double p_313832_, int p_313688_) {
        boolean flag = this.updateScrolling(p_313764_, p_313832_, p_313688_);
        return ContainerEventHandler.super.mouseClicked(p_313764_, p_313832_, p_313688_) || flag;
    }

    @Override
    public boolean mouseReleased(double p_313886_, double p_313935_, int p_313751_) {
        super.mouseReleased(p_313886_, p_313935_, p_313751_);
    ...
    public boolean mouseDragged(double p_313749_, double p_313887_, int p_313839_, double p_313844_, double p_313686_) {
        super.mouseDragged(p_313749_, p_313887_, p_313839_, p_313844_, p_313686_);
