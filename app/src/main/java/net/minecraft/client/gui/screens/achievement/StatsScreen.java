...
public class StatsScreen extends Screen {
    ...
    class ItemStatisticsList extends ObjectSelectionList<StatsScreen.ItemStatisticsList.ItemRow> {
        ...
        public boolean mouseClicked(double p_386623_, double p_387723_, int p_388795_) {
            boolean flag = super.mouseClicked(p_386623_, p_387723_, p_388795_);
            return !flag
                    && this.clickedHeader(
                        (int)(p_386623_ - ((double)this.getX() + (double)this.width / 2.0 - (double)this.getRowWidth() / 2.0)),
                        (int)(p_387723_ - (double)this.getY()) + (int)this.scrollAmount() - 4
                    )
                ? true
                : flag;
        }
