...
public class SystemToast implements Toast {
    ...
    public void update(ToastManager p_364721_, long p_364544_) {
        ...
        double d0 = (double)this.id.displayTime * p_364721_.getNotificationDisplayTimeMultiplier();
    ...
    public static void add(ToastManager p_361789_, SystemToast.SystemToastId p_314591_, Component p_94858_, @Nullable Component p_94859_) {
        p_361789_.addToast(new SystemToast(p_314591_, p_94858_, p_94859_));
    }

    public static void addOrUpdate(ToastManager p_362595_, SystemToast.SystemToastId p_314579_, Component p_94872_, @Nullable Component p_94873_) {
        SystemToast systemtoast = p_362595_.getToast(SystemToast.class, p_314579_);
        if (systemtoast == null) {
            add(p_362595_, p_314579_, p_94872_, p_94873_);
        } else {
            systemtoast.reset(p_94872_, p_94873_);
        }
    }

    public static void forceHide(ToastManager p_361781_, SystemToast.SystemToastId p_314474_) {
        SystemToast systemtoast = p_361781_.getToast(SystemToast.class, p_314474_);
        if (systemtoast != null) {
    ...
    public static void onChunkLoadFailure(Minecraft p_330933_, ChunkPos p_331933_) {
        addOrUpdate(
            p_330933_.getToastManager(),
            SystemToast.SystemToastId.CHUNK_LOAD_FAILURE,
            Component.translatable("chunk.toast.loadFailure", Component.translationArg(p_331933_)).withStyle(ChatFormatting.RED),
    ...
    public static void onChunkSaveFailure(Minecraft p_331849_, ChunkPos p_330399_) {
        addOrUpdate(
            p_331849_.getToastManager(),
            SystemToast.SystemToastId.CHUNK_SAVE_FAILURE,
            Component.translatable("chunk.toast.saveFailure", Component.translationArg(p_330399_)).withStyle(ChatFormatting.RED),
            Component.translatable("chunk.toast.checkLog")
        );
    }
