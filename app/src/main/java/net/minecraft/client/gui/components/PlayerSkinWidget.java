...
public class PlayerSkinWidget extends AbstractWidget {
    ...
    static record Model(PlayerModel wideModel, PlayerModel slimModel) {
        ...
        public void render(GuiGraphics p_300018_, PlayerSkin p_299991_) {
            ...
            p_300018_.pose().translate(0.0F, -1.501F, 0.0F);
            ...
            p_300018_.drawSpecial(
                p_371887_ -> playermodel.renderToBuffer(p_300018_.pose(), p_371887_.getBuffer(rendertype), 15728880, OverlayTexture.NO_OVERLAY)
            );
