...
public class InventoryScreen extends AbstractRecipeBookScreen<InventoryMenu> {
    ...
    public InventoryScreen(Player p_98839_) {
        super(
            p_98839_.inventoryMenu,
            new CraftingRecipeBookComponent(p_98839_.inventoryMenu),
            p_98839_.getInventory(),
    ...
    public static void renderEntityInInventory(
        ...
        p_282665_.drawSpecial(p_370280_ -> entityrenderdispatcher.render(p_282466_, 0.0, 0.0, 0.0, 1.0F, p_282665_.pose(), p_370280_, 15728880));
        p_282665_.flush();
