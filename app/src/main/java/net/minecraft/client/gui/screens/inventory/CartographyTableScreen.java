...
public class CartographyTableScreen extends AbstractContainerScreen<CartographyTableMenu> {
    ...
    private void renderMap(
        ...
        if (p_324470_ != null && p_282897_ != null) {
            ...
            maprenderer.extractRenderState(p_324470_, p_282897_, this.mapRenderState);
            p_282298_.drawSpecial(p_371650_ -> maprenderer.render(this.mapRenderState, p_282298_.pose(), p_371650_, true, 15728880));
