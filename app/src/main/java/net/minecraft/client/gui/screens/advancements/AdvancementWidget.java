...
public class AdvancementWidget {
    ...
    public AdvancementWidget(AdvancementTab p_97255_, Minecraft p_97256_, AdvancementNode p_300868_, DisplayInfo p_97258_) {
        ...
        this.description = Language.getInstance()
            .getVisualOrder(
                this.findOptimalLines(ComponentUtils.mergeStyles(p_97258_.getDescription().copy(), Style.EMPTY.withColor(p_97258_.getType().getChatColor())), k)
            );
    ...
    public void draw(GuiGraphics p_281958_, int p_281323_, int p_283679_) {
        if (!this.display.isHidden() || this.progress != null && this.progress.isDone()) {
            ...
            p_281958_.blitSprite(
                RenderType::guiTextured, advancementwidgettype.frameSprite(this.display.getType()), p_281323_ + this.x + 3, p_283679_ + this.y, 26, 26
            );
    ...
    public void drawHover(GuiGraphics p_283068_, int p_281304_, int p_281253_, float p_281848_, int p_282097_, int p_281537_) {
        ...
        p_283068_.blitSprite(
            RenderType::guiTextured, advancementwidgettype2.frameSprite(this.display.getType()), p_281304_ + this.x + 3, p_281253_ + this.y, 26, 26
        );
        int k2 = i2 + 5;
        if (flag) {
    ...
    private void drawMultilineText(GuiGraphics p_382801_, List<FormattedCharSequence> p_382822_, int p_382842_, int p_383077_, int p_382892_) {
        ...
        for (int i = 0; i < p_382822_.size(); i++) {
            p_382801_.drawString(font, p_382822_.get(i), p_382842_, p_383077_ + i * 9, p_382892_);
        }
    }
