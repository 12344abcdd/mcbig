...
public interface PresetEditor {
    ...
    static WorldCreationContext.DimensionsUpdater flatWorldConfigurator(FlatLevelGeneratorSettings p_250871_) {
        return (p_359110_, p_359111_) -> {
            ...
            return p_359111_.replaceOverworldGenerator(p_359110_, chunkgenerator);
        };
    }
    ...
    private static WorldCreationContext.DimensionsUpdater fixedBiomeConfigurator(Holder<Biome> p_248835_) {
        return (p_367763_, p_367764_) -> {
            Registry<NoiseGeneratorSettings> registry = p_367763_.lookupOrThrow(Registries.NOISE_SETTINGS);
            ...
            return p_367764_.replaceOverworldGenerator(p_367763_, chunkgenerator);
        };
    }
}
