...
public class PlayerTabOverlay {
    ...
    private void renderTablistScore(
        ...
        if (p_283381_.getRenderType() == ObjectiveCriteria.RenderType.HEARTS) {
            ...
            p_282280_.drawString(this.minecraft.font, p_313810_.formattedScore, p_281254_ - p_313810_.scoreWidth, p_282557_, 16777215);
        }
    }
                ...
                for (int i1 = 0; i1 < i; i1++) {
                    ...
                    if (i1 * 2 + 1 < p_281354_) {
                        p_281723_.blitSprite(
                            RenderType::guiTextured, i1 >= 10 ? HEART_ABSORBING_FULL_BLINKING_SPRITE : HEART_FULL_SPRITE, p_283173_ + i1 * k, p_282904_, 9, 9
                        );
                    }

                    if (i1 * 2 + 1 == p_281354_) {
                        p_281723_.blitSprite(
                            RenderType::guiTextured, i1 >= 10 ? HEART_ABSORBING_HALF_BLINKING_SPRITE : HEART_HALF_SPRITE, p_283173_ + i1 * k, p_282904_, 9, 9
                        );
                    }
                }
            }
