...
public class TabNavigationBar extends AbstractContainerEventHandler implements Renderable, NarratableEntry {
    ...
    public boolean isMouseOver(double p_387504_, double p_386568_) {
        return p_387504_ >= (double)this.layout.getX()
            && p_386568_ >= (double)this.layout.getY()
            && p_387504_ < (double)(this.layout.getX() + this.layout.getWidth())
            && p_386568_ < (double)(this.layout.getY() + this.layout.getHeight());
    }
    ...
    public void render(GuiGraphics p_281720_, int p_282085_, int p_281687_, float p_283048_) {
        ...
        p_281720_.blit(RenderType::guiTextured, Screen.HEADER_SEPARATOR, i, this.layout.getY() + this.layout.getHeight() - 2, 0.0F, 0.0F, this.width, 2, 32, 2);
