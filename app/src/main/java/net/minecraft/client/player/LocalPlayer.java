...
public class LocalPlayer extends AbstractClientPlayer {
                ...
                this.connection
                    .send(
                        new ServerboundMovePlayerPacket.PosRot(
                            this.getBigX(), this.getY(), this.getBigZ(), this.getYRot(), this.getXRot(), this.onGround(), this.horizontalCollision
                        )
                    );
            } else if (flag) {
                this.connection.send(new ServerboundMovePlayerPacket.Pos(this.getBigX(), this.getY(), this.getBigZ(), this.onGround(), this.horizontalCollision));
            } else if (flag1) {
                this.connection.send(new ServerboundMovePlayerPacket.Rot(this.getYRot(), this.getXRot(), this.onGround(), this.horizontalCollision));
    ...
    public void removeRecipeHighlight(RecipeDisplayId p_379296_) {
        if (this.recipeBook.willHighlight(p_379296_)) {
            this.recipeBook.removeHighlight(p_379296_);
            this.connection.send(new ServerboundRecipeBookSeenRecipePacket(p_379296_));
        }
    }
