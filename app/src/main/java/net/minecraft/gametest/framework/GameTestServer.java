...
public class GameTestServer extends MinecraftServer {
    ...
    private static final GameRules TEST_GAME_RULES = Util.make(new GameRules(ENABLED_FEATURES), p_351714_ -> {
    ...
    public void tickServer(BooleanSupplier p_177619_) {
        ...
        if (this.testTracker.isDone()) {
            ...
            if (this.testTracker.hasFailedOptional()) {
                ...
                this.testTracker
                    .getFailedOptional()
                    .forEach(p_359464_ -> LOGGER.info("   - {} with rotation: {}", p_359464_.getTestName(), p_359464_.getRotation()));
            }
