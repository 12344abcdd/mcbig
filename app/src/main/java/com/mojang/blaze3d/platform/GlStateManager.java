...
public class GlStateManager {
    ...
    public static void glShaderSource(int p_157117_, String p_366821_) {
        RenderSystem.assertOnRenderThread();
        byte[] abyte = p_366821_.getBytes(Charsets.UTF_8);
    ...
    public static void _glBufferSubData(int p_374381_, int p_374187_, ByteBuffer p_374474_) {
        RenderSystem.assertOnRenderThreadOrInit();
        GL15.glBufferSubData(p_374381_, (long)p_374187_, p_374474_);
    }
    ...
    @Nullable
    public static ByteBuffer _glMapBufferRange(int p_373028_, int p_372964_, int p_373038_, int p_372901_) {
        RenderSystem.assertOnRenderThreadOrInit();
        return GL30.glMapBufferRange(p_373028_, (long)p_372964_, (long)p_373038_, p_372901_);
    }
    ...
    public static long _glFenceSync(int p_373116_, int p_372803_) {
        RenderSystem.assertOnRenderThreadOrInit();
        return GL32.glFenceSync(p_373116_, p_372803_);
    }

    public static int _glClientWaitSync(long p_372851_, int p_373120_, long p_374174_) {
        RenderSystem.assertOnRenderThreadOrInit();
        return GL32.glClientWaitSync(p_372851_, p_373120_, p_374174_);
    }

    public static void _glDeleteSync(long p_373060_) {
        RenderSystem.assertOnRenderThreadOrInit();
    ...
    static class FramebufferState {
        ...
        public boolean update(int p_361117_) {
            if (p_361117_ != this.binding) {
                this.binding = p_361117_;
                return true;
            } else {
                return false;
            }
