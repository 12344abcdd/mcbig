...
public abstract class GlslPreprocessor {
    ...
    public static String injectDefines(String p_366820_, ShaderDefines p_366487_) {
        if (p_366487_.isEmpty()) {
            return p_366820_;
        } else {
            int i = p_366820_.indexOf(10);
            int j = i + 1;
            return p_366820_.substring(0, j) + p_366487_.asSourceDirectives() + "#line 1 0\n" + p_366820_.substring(j);
        }
    }
