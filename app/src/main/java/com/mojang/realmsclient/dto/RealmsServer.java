...
public class RealmsServer extends ValueObject {
    ...
    private static RealmsSettings parseSettings(JsonElement p_380358_) {
        boolean flag = false;
        if (p_380358_.isJsonArray()) {
            for (JsonElement jsonelement : p_380358_.getAsJsonArray()) {
                JsonObject jsonobject = jsonelement.getAsJsonObject();
    ...
    private static boolean readBoolean(JsonObject p_379605_, String p_380254_, boolean p_380296_) {
        String s = JsonUtils.getStringOr("name", p_379605_, null);
        return s != null && s.equals(p_380254_) ? JsonUtils.getBooleanOr("value", p_379605_, p_380296_) : p_380296_;
    }
    ...
    public String getWorldName(int p_87496_) {
        return this.name == null ? this.slots.get(p_87496_).getSlotName(p_87496_) : this.name + " (" + this.slots.get(p_87496_).getSlotName(p_87496_) + ")";
    }
