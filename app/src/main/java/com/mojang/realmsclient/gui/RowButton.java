...
public abstract class RowButton {
    ...
    public static void drawButtonsInRow(
        GuiGraphics p_281401_, List<RowButton> p_283164_, AbstractSelectionList<?> p_380246_, int p_282527_, int p_281326_, int p_281575_, int p_282538_
    ) {
        for (RowButton rowbutton : p_283164_) {
            if (p_380246_.getRowWidth() > rowbutton.getRight()) {
    ...
    public static void rowButtonMouseClicked(
        AbstractSelectionList<?> p_380122_, ObjectSelectionList.Entry<?> p_88038_, List<RowButton> p_88039_, int p_88040_, double p_88041_, double p_88042_
    ) {
        int i = p_380122_.children().indexOf(p_88038_);
        if (i > -1) {
            p_380122_.setSelectedIndex(i);
            int j = p_380122_.getRowLeft();
            int k = p_380122_.getRowTop(i);
